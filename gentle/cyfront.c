...
yyeq_UNIT(t1, t2) yy t1, t2;
{
  switch (t1[0]) {
  case 1:
    return (t2[0] == 1) && yyeq_IDENT((yy)t1[1], (yy)t2[1]) &&
...
yybroadcast_UNIT(t, In, Out, Handler) yy t, In, *Out;
int (*Handler)();
{
  yy A, B;
  A = In;
...
yyeq_EXPORT(t1, t2) yy t1, t2;
{
  switch (t1[0]) {
  case 1:
    return (t2[0] == 1) && yyeq_IDENTLIST((yy)t1[1], (yy)t2[1]) &&
           (t1[2] == t2[2]);
  }
}
...
yybroadcast_EXPORT(t, In, Out, Handler) yy t, In, *Out;
int (*Handler)();
{
  yy A, B;
  A = In;
...
yyeq_DECLARATION(t1, t2) yy t1, t2;
{
  switch (t1[0]) {
  case 1:
    return (t2[0] == 1) && (t1[1] == t2[1]) &&
           yyeq_MEMBERS((yy)t1[2], (yy)t2[2]);
  case 2:
    return (t2[0] == 2) && yyeq_IDENT((yy)t1[1], (yy)t2[1]) &&
           (t1[2] == t2[2]) && yyeq_ASSOC((yy)t1[3], (yy)t2[3]);
  }
}
...
yybroadcast_DECLARATION(t, In, Out, Handler) yy t, In, *Out;
int (*Handler)();
{
  yy A, B;
  A = In;
...
yyeq_ASSOC(t1, t2) yy t1, t2;
{
  switch (t1[0]) {
  case 1:
    return (t2[0] == 1) && yyeq_TYPEKIND((yy)t1[1], (yy)t2[1]) &&
           yyeq_FUNCTORSPECLIST((yy)t1[2], (yy)t2[2]);
  case 2:
    return (t2[0] == 2) && yyeq_IDENT((yy)t1[1], (yy)t2[1]) && (t1[2] == t2[2]);
  case 3:
    return (t2[0] == 3) && yyeq_TABLEFIELDLIST((yy)t1[1], (yy)t2[1]);
  case 4:
    return (t2[0] == 4) && yyeq_CODENAME((yy)t1[1], (yy)t2[1]) &&
...
yybroadcast_ASSOC(t, In, Out, Handler) yy t, In, *Out;
int (*Handler)();
{
  yy A, B;
  A = In;
...
yybroadcast_TYPEKIND(t, In, Out, Handler) yy t, In, *Out;
int (*Handler)();
{
  yy A, B;
  A = In;
...
yybroadcast_CODENAME(t, In, Out, Handler) yy t, In, *Out;
int (*Handler)();
{
  yy A, B;
  A = In;
...
yybroadcast_BASECLASS(t, In, Out, Handler) yy t, In, *Out;
int (*Handler)();
{
  yy A, B;
  A = In;
...
yyeq_TABLEFIELDLIST(t1, t2) yy t1, t2;
{
  switch (t1[0]) {
  case 1:
    return (t2[0] == 1) && yyeq_TABLEFIELD((yy)t1[1], (yy)t2[1]) &&
...
yybroadcast_TABLEFIELDLIST(t, In, Out, Handler) yy t, In, *Out;
int (*Handler)();
{
  yy A, B;
  A = In;
...
yyeq_TABLEFIELD(t1, t2) yy t1, t2;
{
  ...
  case 1:
    return (t2[0] == 1) && yyeq_IDENT((yy)t1[1], (yy)t2[1]) &&
           yyeq_IDENT((yy)t1[2], (yy)t2[2]) && (t1[3] == t2[3]);
  }
}
...
yybroadcast_TABLEFIELD(t, In, Out, Handler) yy t, In, *Out;
int (*Handler)();
{
  yy A, B;
  A = In;
...
yyeq_FUNCTORSPEC(t1, t2) yy t1, t2;
{
  ...
  case 1:
    return (t2[0] == 1) && yyeq_IDENT((yy)t1[1], (yy)t2[1]) &&
           (t1[2] == t2[2]) && yyeq_ARGSPECLIST((yy)t1[3], (yy)t2[3]);
  }
}
...
yybroadcast_FUNCTORSPEC(t, In, Out, Handler) yy t, In, *Out;
int (*Handler)();
{
  yy A, B;
  A = In;
...
yyeq_ARGSPEC(t1, t2) yy t1, t2;
{
  switch (t1[0]) {
  case 1:
    return (t2[0] == 1) && yyeq_FORMALNAME((yy)t1[1], (yy)t2[1]) &&
...
yybroadcast_ARGSPEC(t, In, Out, Handler) yy t, In, *Out;
int (*Handler)();
{
  yy A, B;
  A = In;
...
yybroadcast_FORMALNAME(t, In, Out, Handler) yy t, In, *Out;
int (*Handler)();
{
  yy A, B;
  A = In;
...
yybroadcast_ACCESS(t, In, Out, Handler) yy t, In, *Out;
int (*Handler)();
{
  yy A, B;
  A = In;
...
yyeq_FORMALS(t1, t2) yy t1, t2;
{
  switch (t1[0]) {
  case 1:
    return (t2[0] == 1) && yyeq_ARGSPECLIST((yy)t1[1], (yy)t2[1]) &&
...
yybroadcast_FORMALS(t, In, Out, Handler) yy t, In, *Out;
int (*Handler)();
{
  yy A, B;
  A = In;
...
yybroadcast_CLASS(t, In, Out, Handler) yy t, In, *Out;
int (*Handler)();
{
  yy A, B;
  A = In;
...
yyeq_RULE(t1, t2) yy t1, t2;
{
  switch (t1[0]) {
  case 1:
    return (t2[0] == 1) && yyeq_LHS((yy)t1[1], (yy)t2[1]) &&
           yyeq_MEMBERS((yy)t1[2], (yy)t2[2]) && (t1[3] == t2[3]);
  }
}
yyPrint_RULE(t) yy t;
{
...
yybroadcast_RULE(t, In, Out, Handler) yy t, In, *Out;
int (*Handler)();
{
  yy A, B;
  A = In;
...
yyeq_LHS(t1, t2) yy t1, t2;
{
  ...
  case 1:
    return (t2[0] == 1) && yyeq_IDENT((yy)t1[1], (yy)t2[1]) &&
           (t1[2] == t2[2]) && yyeq_DEFARGLIST((yy)t1[3], (yy)t2[3]) &&
...
yybroadcast_LHS(t, In, Out, Handler) yy t, In, *Out;
int (*Handler)();
{
  yy A, B;
  A = In;
...
yyeq_MEMBER(t1, t2) yy t1, t2;
{
  switch (t1[0]) {
  case 1:
    return (t2[0] == 1) && yyeq_DEFARG((yy)t1[1], (yy)t2[1]) &&
           yyeq_USEARG((yy)t1[2], (yy)t2[2]) && (t1[3] == t2[3]);
  case 2:
    return (t2[0] == 2) && yyeq_IDENT((yy)t1[1], (yy)t2[1]) &&
           (t1[2] == t2[2]) && yyeq_USEARG((yy)t1[3], (yy)t2[3]);
  case 3:
    return (t2[0] == 3) && yyeq_IDENT((yy)t1[1], (yy)t2[1]) &&
           (t1[2] == t2[2]) && yyeq_DEFARG((yy)t1[3], (yy)t2[3]);
  case 4:
    return (t2[0] == 4) && yyeq_IDENT((yy)t1[1], (yy)t2[1]) &&
           yyeq_IDENT((yy)t1[2], (yy)t2[2]) && (t1[3] == t2[3]) &&
           yyeq_REF_INT((yy)t1[4], (yy)t2[4]);
  case 5:
    return (t2[0] == 5) && yyeq_IDENT((yy)t1[1], (yy)t2[1]) &&
           yyeq_IDENT((yy)t1[2], (yy)t2[2]) &&
           yyeq_USEARG((yy)t1[3], (yy)t2[3]) && (t1[4] == t2[4]);
  case 6:
    return (t2[0] == 6) && yyeq_IDENT((yy)t1[1], (yy)t2[1]) &&
           yyeq_IDENT((yy)t1[2], (yy)t2[2]) &&
           yyeq_DEFARG((yy)t1[3], (yy)t2[3]) && (t1[4] == t2[4]);
  case 7:
    return (t2[0] == 7) && yyeq_IDENT((yy)t1[1], (yy)t2[1]) &&
           (t1[2] == t2[2]) && yyeq_USEARGLIST((yy)t1[3], (yy)t2[3]) &&
           yyeq_DEFARGLIST((yy)t1[4], (yy)t2[4]) &&
           yyeq_REF_INT((yy)t1[5], (yy)t2[5]);
  case 8:
    return (t2[0] == 8) && (strcmp((char *)t1[1], (char *)t2[1]) == 0) &&
           (t1[2] == t2[2]);
  case 9:
    return (t2[0] == 9) && yyeq_DEFARG((yy)t1[1], (yy)t2[1]) &&
           (t1[2] == t2[2]);
  case 10:
    return (t2[0] == 10) && yyeq_ALTERNATIVELIST((yy)t1[1], (yy)t2[1]) &&
           yyeq_REF_IDENTLIST((yy)t1[2], (yy)t2[2]) && (t1[3] == t2[3]);
  case 11:
    return (t2[0] == 11) && yyeq_MEMBERS((yy)t1[1], (yy)t2[1]) &&
           (t1[2] == t2[2]);
  }
}
...
yybroadcast_MEMBER(t, In, Out, Handler) yy t, In, *Out;
int (*Handler)();
{
  yy A, B;
  A = In;
...
yyeq_MEMBERS(t1, t2) yy t1, t2;
{
  switch (t1[0]) {
  case 1:
    return (t2[0] == 1) && yyeq_MEMBERLIST((yy)t1[1], (yy)t2[1]) &&
...
yybroadcast_MEMBERS(t, In, Out, Handler) yy t, In, *Out;
int (*Handler)();
{
  yy A, B;
  A = In;
...
yyeq_DEFARG(t1, t2) yy t1, t2;
{
  switch (t1[0]) {
  case 1:
    return (t2[0] == 1) && yyeq_REF_TEMPO((yy)t1[1], (yy)t2[1]) &&
           yyeq_IDENT((yy)t1[2], (yy)t2[2]) && (t1[3] == t2[3]) &&
           yyeq_DEFARGLIST((yy)t1[4], (yy)t2[4]);
  case 2:
    return (t2[0] == 2) && yyeq_IDENT((yy)t1[1], (yy)t2[1]) &&
           yyeq_REF_TEMPO((yy)t1[2], (yy)t2[2]) &&
           yyeq_IDENT((yy)t1[3], (yy)t2[3]) && (t1[4] == t2[4]) &&
           yyeq_DEFARGLIST((yy)t1[5], (yy)t2[5]);
  case 3:
    return (t2[0] == 3) && yyeq_REF_TEMPO((yy)t1[1], (yy)t2[1]) &&
           yyeq_IDENT((yy)t1[2], (yy)t2[2]) && (t1[3] == t2[3]);
  case 4:
    return (t2[0] == 4) && yyeq_REF_TEMPO((yy)t1[1], (yy)t2[1]) &&
           yyeq_IDENT((yy)t1[2], (yy)t2[2]) && (t1[3] == t2[3]) &&
           yyeq_DEFARG((yy)t1[4], (yy)t2[4]);
  case 5:
    return (t2[0] == 5) && yyeq_REF_TEMPO((yy)t1[1], (yy)t2[1]) &&
           (t1[2] == t2[2]);
  case 6:
    return (t2[0] == 6);
  }
...
yybroadcast_DEFARG(t, In, Out, Handler) yy t, In, *Out;
int (*Handler)();
{
  yy A, B;
  A = In;
...
yyeq_USEARG(t1, t2) yy t1, t2;
{
  ...
  case 1:
    return (t2[0] == 1) && yyeq_REF_TEMPO((yy)t1[1], (yy)t2[1]) &&
           yyeq_BINOP((yy)t1[2], (yy)t2[2]) && (t1[3] == t2[3]) &&
           yyeq_USEARG((yy)t1[4], (yy)t2[4]) &&
           yyeq_USEARG((yy)t1[5], (yy)t2[5]);
  case 2:
    return (t2[0] == 2) && yyeq_REF_TEMPO((yy)t1[1], (yy)t2[1]) &&
           yyeq_MONOP((yy)t1[2], (yy)t2[2]) && (t1[3] == t2[3]) &&
           yyeq_USEARG((yy)t1[4], (yy)t2[4]);
  case 3:
    return (t2[0] == 3) && yyeq_REF_TEMPO((yy)t1[1], (yy)t2[1]) &&
           yyeq_REF_INT((yy)t1[2], (yy)t2[2]) &&
  ...
  case 5:
    return (t2[0] == 5) && yyeq_REF_TEMPO((yy)t1[1], (yy)t2[1]) &&
           yyeq_IDENT((yy)t1[2], (yy)t2[2]) && (t1[3] == t2[3]);
  case 6:
    return (t2[0] == 6) && yyeq_REF_TEMPO((yy)t1[1], (yy)t2[1]) &&
           (t1[2] == t2[2]) && (t1[3] == t2[3]);
  case 7:
    return (t2[0] == 7) && yyeq_REF_TEMPO((yy)t1[1], (yy)t2[1]) &&
           (strcmp((char *)t1[2], (char *)t2[2]) == 0) && (t1[3] == t2[3]);
  }
}
...
yybroadcast_USEARG(t, In, Out, Handler) yy t, In, *Out;
int (*Handler)();
{
  yy A, B;
  A = In;
...
yyeq_TEMPO(t1, t2) yy t1, t2;
{
  switch (t1[0]) {
  case 1:
    return (t2[0] == 1) && (t1[1] == t2[1]) && yyeq_TEMPO((yy)t1[2], (yy)t2[2]);
  case 2:
    return (t2[0] == 2);
  }
}
...
yybroadcast_TEMPO(t, In, Out, Handler) yy t, In, *Out;
int (*Handler)();
{
  yy A, B;
  A = In;
...
yybroadcast_BINOP(t, In, Out, Handler) yy t, In, *Out;
int (*Handler)();
{
  yy A, B;
  A = In;
...
yybroadcast_MONOP(t, In, Out, Handler) yy t, In, *Out;
int (*Handler)();
{
  yy A, B;
  A = In;
...
yyeq_UNITLIST(t1, t2) yy t1, t2;
{
  switch (t1[0]) {
  case 1:
    return (t2[0] == 1) && yyeq_UNIT((yy)t1[1], (yy)t2[1]) &&
...
yybroadcast_UNITLIST(t, In, Out, Handler) yy t, In, *Out;
int (*Handler)();
{
  yy A, B;
  A = In;
...
yybroadcast_IDENTLIST(t, In, Out, Handler) yy t, In, *Out;
int (*Handler)();
{
  yy A, B;
  A = In;
...
yyeq_DECLARATIONLIST(t1, t2) yy t1, t2;
{
  switch (t1[0]) {
  case 1:
    return (t2[0] == 1) && yyeq_DECLARATION((yy)t1[1], (yy)t2[1]) &&
...
yybroadcast_DECLARATIONLIST(t, In, Out, Handler) yy t, In, *Out;
int (*Handler)();
{
  yy A, B;
  A = In;
...
yyeq_FUNCTORSPECLIST(t1, t2) yy t1, t2;
{
  switch (t1[0]) {
  case 1:
    return (t2[0] == 1) && yyeq_FUNCTORSPEC((yy)t1[1], (yy)t2[1]) &&
           yyeq_FUNCTORSPECLIST((yy)t1[2], (yy)t2[2]);
  case 2:
    return (t2[0] == 2);
  }
...
yybroadcast_FUNCTORSPECLIST(t, In, Out, Handler) yy t, In, *Out;
int (*Handler)();
{
  yy A, B;
  A = In;
...
yyeq_ARGSPECLIST(t1, t2) yy t1, t2;
{
  switch (t1[0]) {
  case 1:
    return (t2[0] == 1) && yyeq_ARGSPEC((yy)t1[1], (yy)t2[1]) &&
           (t1[2] == t2[2]) && yyeq_ARGSPECLIST((yy)t1[3], (yy)t2[3]);
  case 2:
    return (t2[0] == 2);
  }
...
yybroadcast_ARGSPECLIST(t, In, Out, Handler) yy t, In, *Out;
int (*Handler)();
{
  yy A, B;
  A = In;
...
yyeq_RULELIST(t1, t2) yy t1, t2;
{
  switch (t1[0]) {
  case 1:
    return (t2[0] == 1) && yyeq_RULE((yy)t1[1], (yy)t2[1]) &&
...
yybroadcast_RULELIST(t, In, Out, Handler) yy t, In, *Out;
int (*Handler)();
{
  yy A, B;
  A = In;
...
yyeq_MEMBERLIST(t1, t2) yy t1, t2;
{
  switch (t1[0]) {
  case 1:
    return (t2[0] == 1) && yyeq_MEMBER((yy)t1[1], (yy)t2[1]) &&
...
yybroadcast_MEMBERLIST(t, In, Out, Handler) yy t, In, *Out;
int (*Handler)();
{
  yy A, B;
  A = In;
...
yyeq_ALTERNATIVELIST(t1, t2) yy t1, t2;
{
  switch (t1[0]) {
  case 1:
    return (t2[0] == 1) && yyeq_MEMBERS((yy)t1[1], (yy)t2[1]) &&
           (t1[2] == t2[2]) && yyeq_ALTERNATIVELIST((yy)t1[3], (yy)t2[3]);
  case 2:
    return (t2[0] == 2);
  }
}
...
yybroadcast_ALTERNATIVELIST(t, In, Out, Handler) yy t, In, *Out;
int (*Handler)();
{
  yy A, B;
  A = In;
...
yyeq_USEARGLIST(t1, t2) yy t1, t2;
{
  switch (t1[0]) {
  case 1:
    return (t2[0] == 1) && yyeq_USEARG((yy)t1[1], (yy)t2[1]) &&
           (t1[2] == t2[2]) && yyeq_USEARGLIST((yy)t1[3], (yy)t2[3]);
  case 2:
    return (t2[0] == 2) && (t1[1] == t2[1]);
  }
}
...
yybroadcast_USEARGLIST(t, In, Out, Handler) yy t, In, *Out;
int (*Handler)();
{
  yy A, B;
  A = In;
...
yybroadcast_DEFARGLIST(t, In, Out, Handler) yy t, In, *Out;
int (*Handler)();
{
  yy A, B;
  A = In;
...
yybroadcast_BOOL(t, In, Out, Handler) yy t, In, *Out;
int (*Handler)();
{
  yy A, B;
  A = In;
...
yyeq_TOKENLIST(t1, t2) yy t1, t2;
{
  switch (t1[0]) {
  case 1:
    return (t2[0] == 1) && yyeq_TokenIndex((yy)t1[1], (yy)t2[1]) &&
...
yybroadcast_TOKENLIST(t, In, Out, Handler) yy t, In, *Out;
int (*Handler)();
{
  yy A, B;
  A = In;
...
yyeq_TYPEDIDLIST(t1, t2) yy t1, t2;
{
  switch (t1[0]) {
  case 1:
    return (t2[0] == 1) && yyeq_TYPEDID((yy)t1[1], (yy)t2[1]) &&
...
yybroadcast_TYPEDIDLIST(t, In, Out, Handler) yy t, In, *Out;
int (*Handler)();
{
  yy A, B;
  A = In;
...
yybroadcast_TYPEDID(t, In, Out, Handler) yy t, In, *Out;
int (*Handler)();
{
  yy A, B;
  A = In;
...
yybroadcast_CODEKIND(t, In, Out, Handler) yy t, In, *Out;
int (*Handler)();
{
  yy A, B;
  A = In;
...
yyeq_RULEGROUPLIST(t1, t2) yy t1, t2;
{
  switch (t1[0]) {
  case 1:
    return (t2[0] == 1) && yyeq_RULEGROUP((yy)t1[1], (yy)t2[1]) &&
...
yybroadcast_RULEGROUPLIST(t, In, Out, Handler) yy t, In, *Out;
int (*Handler)();
{
  yy A, B;
  A = In;
...
yybroadcast_RULEGROUP(t, In, Out, Handler) yy t, In, *Out;
int (*Handler)();
{
  yy A, B;
  A = In;
...
yybroadcast_ENV(t, In, Out, Handler) yy t, In, *Out;
int (*Handler)();
{
  yy A, B;
  A = In;
...
yybroadcast_TYPECHECKFLAG(t, In, Out, Handler) yy t, In, *Out;
int (*Handler)();
{
  yy A, B;
  A = In;
...
yybroadcast_CHOICETYPELIST(t, In, Out, Handler) yy t, In, *Out;
int (*Handler)();
{
  yy A, B;
  A = In;
...
yybroadcast_CHOICEFUNCTORLIST(t, In, Out, Handler) yy t, In, *Out;
int (*Handler)();
{
  yy A, B;
  A = In;
...
yybroadcast_PREDICATELIST(t, In, Out, Handler) yy t, In, *Out;
int (*Handler)();
{
  yy A, B;
  A = In;
...
yyeq_PATH(t1, t2) yy t1, t2;
{
  switch (t1[0]) {
  case 1:
    return (t2[0] == 1) && yyeq_PATH((yy)t1[1], (yy)t2[1]) && (t1[2] == t2[2]);
  case 2:
    return (t2[0] == 2);
  }
}
...
yybroadcast_PATH(t, In, Out, Handler) yy t, In, *Out;
int (*Handler)();
{
  yy A, B;
  A = In;
...
yybroadcast_VARPATHES(t, In, Out, Handler) yy t, In, *Out;
int (*Handler)();
{
  yy A, B;
  A = In;
...
yybroadcast_CHOICEMEMBERLIST(t, In, Out, Handler) yy t, In, *Out;
int (*Handler)();
{
  yy A, B;
  A = In;
...
yybroadcast_EXPORTABLE(t, In, Out, Handler) yy t, In, *Out;
int (*Handler)();
{
  yy A, B;
  A = In;
...
{
  {
    ...
    yyv_Pos = yy_0_2;
    {
      ...
      yy_1_1_1_1 = yyv_Str;
      yy_1_1_1_2 = ((yy) "");
      if (strcmp((char *)yy_1_1_1_1, (char *)yy_1_1_1_2) != 0)
        goto yyfl_166_1_1_1;
...
LookupAnonToken(yyin_1, yyin_2, yyin_3, yyout_1) yy yyin_1;
yy yyin_2;
yy yyin_3;
yy *yyout_1;
{
  {
    ...
    yyv_Repr = yy_1;
    {
      ...
      yy_2_1_1_1 = yyv_Str;
      yy_2_1_1_2 = yyv_Repr;
      if (strcmp((char *)yy_2_1_1_1, (char *)yy_2_1_1_2) != 0)
        goto yyfl_167_1_2_1;
      ...
      yyv_Ident = yy_2_1_2;
      {
        ...
        if (yy_2_1_3_1_1 == (yy)yyu)
          yyErr(1, 1153);
        if (yy_2_1_3_1_1[0] != 1)
          goto yyfl_167_1_2_1_3_1;
        yy_2_1_3_1_2_1 = ((yy) "use symbolic name '");
        yy_2_1_3_1_2_2 = yyv_Ident;
        yy_2_1_3_1_2_3 = ((yy) "'");
        yy_2_1_3_1_2_4 = yyv_Pos;
        MESSAGE1(yy_2_1_3_1_2_1, yy_2_1_3_1_2_2, yy_2_1_3_1_2_3,
                 yy_2_1_3_1_2_4);
...
WriteTokenDescr(yyin_1) yy yyin_1;
{
  {
    yy yyb;
    yy yy_0_1;
...
{
  {
    ...
    yyv_UN = yy_16_2;
    {
      ...
      yy_17_1_1_1 = yyv_SN;
      yy_17_1_1_2 = yyv_UN;
      if (strcmp((char *)yy_17_1_1_1, (char *)yy_17_1_1_2) != 0)
        goto yyfl_172_1_17_1;
      goto yysl_172_1_17;
    yyfl_172_1_17_1:;
      yy_17_2_1_1 = ((yy) "'");
...
CheckExport(yyin_1, yyin_2) yy yyin_1;
yy yyin_2;
{
  {
    yy yyb;
    ...
    yyv_Pos = yy_0_2;
    {
      yy yysb = yyb;
      yy_1_1_1_1 = yyv_H;
      if (!GetGlobalMeaning(yy_1_1_1_1, &yy_1_1_1_2))
        goto yyfl_177_1_1_1;
      yyv_Assoc = yy_1_1_1_2;
      {
        yy yysb = yyb;
        yy_1_1_2_1_1_1 = yyv_H;
        if (!GetExportFlag(yy_1_1_2_1_1_1, &yy_1_1_2_1_1_2))
          goto yyfl_177_1_1_1_2_1;
        if (yy_1_1_2_1_1_2[0] != 1)
          goto yyfl_177_1_1_1_2_1;
      ...
      yyfl_177_1_1_1_2_1:;
        ...
        MESSAGE1(yy_1_1_2_2_1_1, yy_1_1_2_2_1_2, yy_1_1_2_2_1_3,
                 yy_1_1_2_2_1_4);
        goto yysl_177_1_1_1_2;
      yysl_177_1_1_1_2:;
        yyb = yysb;
      }
      {
        ...
        if (yy_1_1_3_1_1_2[0] != 4)
          goto yyfl_177_1_1_1_3_1;
      ...
      yyfl_177_1_1_1_3_1:;
        ...
        MESSAGE1(yy_1_1_3_2_3_1, yy_1_1_3_2_3_2, yy_1_1_3_2_3_3,
                 yy_1_1_3_2_3_4);
        goto yysl_177_1_1_1_3;
      yyfl_177_1_1_1_3_2:;
        goto yysl_177_1_1_1_3;
...
MakeImportedItemsVisible_UNITLIST(yyin_1) yy yyin_1;
{
  {
    yy yyb;
    yy yy_0_1;
...
MakeImportedItemsVisible_UNIT(yyin_1) yy yyin_1;
{
  {
    yy yyb;
    yy yy_0_1;
...
MakeImportedItemsVisible_DECLARATIONLIST(yyin_1, yyin_2) yy yyin_1;
yy yyin_2;
{
  {
    yy yyb;
...
DefineItem(yyin_1, yyin_2) yy yyin_1;
yy yyin_2;
{
  {
    yy yyb;
    ...
    yyv_Exportable = yy_0_2;
    {
      ...
      yyv_Rules = yy_1_1_1_2_4;
      {
        ...
        MESSAGE1(yy_1_1_2_1_3_1, yy_1_1_2_1_3_2, yy_1_1_2_1_3_3,
                 yy_1_1_2_1_3_4);
    ...
    yyfl_183_1_1_1:;
      {
        ...
        if (yy_1_2_1_1_1_2[0] != 1)
          goto yyfl_183_1_1_2_1_1;
      ...
      }
      {
        ...
        if (!GetGlobalMeaning(yy_1_2_2_1_1_1, &yy_1_2_2_1_1_2))
          goto yyfl_183_1_1_2_2_1;
        yy_1_2_2_1_2_1 = ((yy) "'");
        yy_1_2_2_1_2_2 = yyv_Id;
        yy_1_2_2_1_2_3 = ((yy) "' already declared");
        yy_1_2_2_1_2_4 = yyv_Pos;
        MESSAGE1(yy_1_2_2_1_2_1, yy_1_2_2_1_2_2, yy_1_2_2_1_2_3,
                 yy_1_2_2_1_2_4);
...
EnterFunctors(yyin_1, yyin_2) yy yyin_1;
yy yyin_2;
{
  {
    yy yyb;
    ...
    yyv_Functor = yy_1_2_1;
    {
      ...
      if (!GetFunctorMeaning(yy_2_1_1_1, &yy_2_1_1_2))
        goto yyfl_184_1_2_1;
      yyv_Old = yy_2_1_1_2;
      goto yysl_184_1_2;
    yyfl_184_1_2_1:;
...
MakeImportedItemsVisible_DECLARATION(yyin_1, yyin_2) yy yyin_1;
yy yyin_2;
{
  {
    yy yyb;
    ...
    yyv_ExportList = yy_0_2;
    {
      ...
      yy_1_1_1_2 = yyv_Id;
      if (!IsInList(yy_1_1_1_1, yy_1_1_1_2))
        goto yyfl_185_1_1_1;
      yy_1_1_2_1 = yyv_Decl;
      yy_1_1_2_2 = yyb + 0;
      yy_1_1_2_2[0] = 2;
...
MakeGlobalItemsVisible(yyin_1) yy yyin_1;
{
  {
    yy yyb;
    yy yy_0_1;
...
MakeGlobalItemsVisible_DECLARATIONLIST(yyin_1) yy yyin_1;
{
  {
    yy yyb;
    yy yy_0_1;
...
MakeGlobalItemsVisible_DECLARATION(yyin_1) yy yyin_1;
{
  {
    yy yyb;
    yy yyv_Decl;
...
LookForGrammarSymbol(yyin_1) yy yyin_1;
{
  {
    yy yyb;
    yy yy_0_1;
...
Length_ARGSPECLIST(yyin_1, yyout_1) yy yyin_1;
yy *yyout_1;
{
  {
    yy yyb;
...
CountAttributes(yyin_1, yyin_2) yy yyin_1;
yy yyin_2;
{
  {
    yy yyb;
  ...
  }
  {
    ...
    yyv_Max = yy_1;
    {
      ...
      yy_2_1_1_1 = yyv_N;
      yy_2_1_1_2 = yyv_Max;
      if ((long)yy_2_1_1_1 <= (long)yy_2_1_1_2)
        goto yyfl_191_2_2_1;
      yy_2_1_2 = yyv_N;
...
ImportDeclarations_DECLARATIONLIST(yyin_1) yy yyin_1;
{
  {
    yy yyb;
    yy yy_0_1;
...
ImportDeclarations_DECLARATION(yyin_1) yy yyin_1;
{
  {
    yy yyb;
    yy yy_0_1;
...
DefineTempos_RULE(yyin_1, yyout_1) yy yyin_1;
yy *yyout_1;
{
  {
    yy yyb;
...
DefineTempos_LHS(yyin_1, yyin_2) yy yyin_1;
yy yyin_2;
{
  {
    yy yyb;
...
DefineTempos_RHS(yyin_1, yyin_2, yyin_3, yyout_1) yy yyin_1;
yy yyin_2;
yy yyin_3;
yy *yyout_1;
{
...
DefineTempos_MEMBERS(yyin_1, yyin_2, yyin_3, yyout_1) yy yyin_1;
yy yyin_2;
yy yyin_3;
yy *yyout_1;
{
...
DefineTempos_MEMBERLIST(yyin_1, yyin_2, yyin_3, yyout_1) yy yyin_1;
yy yyin_2;
yy yyin_3;
yy *yyout_1;
{
...
DefineTempos_MEMBER(yyin_1, yyin_2, yyin_3, yyout_1) yy yyin_1;
yy yyin_2;
yy yyin_3;
yy *yyout_1;
{
...
DefineTempos_ALTERNATIVELIST(yyin_1, yyin_2, yyout_1) yy yyin_1;
yy yyin_2;
yy *yyout_1;
{
  {
...
DefineTempos_DEFARGS(yyin_1, yyin_2, yyin_3, yyout_1, yyout_2) yy yyin_1;
yy yyin_2;
yy yyin_3;
yy *yyout_1;
yy *yyout_2;
...
DefineTempos_USEARGS(yyin_1, yyin_2, yyout_1) yy yyin_1;
yy yyin_2;
yy *yyout_1;
{
  {
...
DefineTempos_DEFARG(yyin_1, yyin_2, yyin_3, yyout_1) yy yyin_1;
yy yyin_2;
yy yyin_3;
yy *yyout_1;
{
...
DefineTempos_USEARG(yyin_1, yyin_2) yy yyin_1;
yy yyin_2;
{
  {
    yy yyb;
...
MakeTempo(yyin_1, yyin_2) yy yyin_1;
yy yyin_2;
{
  {
    yy yyb;
...
int IsDeclared(yyin_1) yy yyin_1;
{
  {
    yy yyb;
    yy yyv_Id;
...
int IsInList(yyin_1, yyin_2) yy yyin_1;
yy yyin_2;
{
  {
    yy yyb;
    ...
    yyv_Id = yy_0_2;
    {
      ...
      yy_1_1_1_1 = yyv_H;
      yy_1_1_1_2 = yyv_Id;
      if (!yyeq_IDENT(yy_1_1_1_1, yy_1_1_1_2))
        goto yyfl_209_1_1_1;
      goto yysl_209_1_1;
    yyfl_209_1_1_1:;
      yy_1_2_1_1 = yyv_T;
      yy_1_2_1_2 = yyv_Id;
      if (!IsInList(yy_1_2_1_1, yy_1_2_1_2))
        goto yyfl_209_1_1_2;
      goto yysl_209_1_1;
    yyfl_209_1_1_2:;
      goto yyfl_209_1;
...
Length(yyin_1, yyout_1) yy yyin_1;
yy *yyout_1;
{
  {
    yy yyb;
...
NumberOfArgs(yyin_1, yyout_1) yy yyin_1;
yy *yyout_1;
{
  {
    yy yyb;
...
Intersection(yyin_1, yyin_2, yyout_1) yy yyin_1;
yy yyin_2;
yy *yyout_1;
{
  {
...
Append(yyin_1, yyin_2, yyout_1) yy yyin_1;
yy yyin_2;
yy *yyout_1;
{
  {
...
BuildTypedVars(yyin_1, yyout_1) yy yyin_1;
yy *yyout_1;
{
  {
    yy yyb;
    ...
    if (yyh > yyhx)
      yyExtend();
    yy_1_1 = yyv_H;
    if (!GetLocalMeaning(yy_1_1, &yy_1_2))
      goto yyfl_216_1;
    yyv_Type = yy_1_2;
    yy_2_1 = yyv_T;
...
DeclareTypedVars(yyin_1, yyin_2) yy yyin_1;
yy yyin_2;
{
  {
    yy yyb;
...
CheckConsistent(yyin_1, yyin_2, yyin_3) yy yyin_1;
yy yyin_2;
yy yyin_3;
{
  {
...
ReserveSpace(yyin_1, yyout_1) yy yyin_1;
yy *yyout_1;
{
  {
    yy yyb;
...
{
  {
    ...
    Code_DECLARATIONLIST(yy_11_1);
    {
      ...
      yyv_Decls = yy_12_1_17;
      {
        ...
        if (yy_12_1_18_1_1_2[0] != 2)
          goto yyfl_227_1_12_1_18_1;
...
TokenCode_DECLARATIONLIST(yyin_1, yyin_2, yyin_3) yy yyin_1;
yy yyin_2;
yy yyin_3;
{
  {
...
GrammarCode_DECLARATIONLIST(yyin_1) yy yyin_1;
{
  {
    yy yyb;
    yy yy_0_1;
...
ForwardCode_DECLARATIONLIST(yyin_1, yyin_2) yy yyin_1;
yy yyin_2;
{
  {
    yy yyb;
...
Code_DECLARATIONLIST(yyin_1) yy yyin_1;
{
  {
    yy yyb;
    yy yy_0_1;
...
TokenCode_DECLARATION(yyin_1, yyin_2, yyin_3) yy yyin_1;
yy yyin_2;
yy yyin_3;
{
  {
...
CodeAnonTokenList(yyin_1, yyin_2) yy yyin_1;
yy yyin_2;
{
  {
    yy yyb;
...
GrammarCode_DECLARATION(yyin_1) yy yyin_1;
{
  {
    yy yyb;
    yy yy_0_1;
...
ForwardCode_DECLARATION(yyin_1, yyin_2) yy yyin_1;
yy yyin_2;
{
  {
    yy yyb;
...
Code_TableEQRoutines(yyin_1) yy yyin_1;
{
  {
    yy yyb;
    yy yyv_Id;
...
Code_TablePrintRoutine(yyin_1) yy yyin_1;
{
  {
    yy yyb;
    yy yyv_Id;
...
Code_EQRoutines(yyin_1, yyin_2, yyin_3) yy yyin_1;
yy yyin_2;
yy yyin_3;
{
  {
    ...
    nl();
    {
      yy yysb = yyb;
      {
        ...
        if (yy_7_1_1_1_1_2[0] != 2)
          goto yyfl_239_1_7_1_1_1;
        goto yysl_239_1_7_1_1;
      yyfl_239_1_7_1_1_1:;
        yy_7_1_1_2_1_1 = yyv_Kind;
        yy_7_1_1_2_1_2 = yy_7_1_1_2_1_1;
        if (yy_7_1_1_2_1_2[0] != 2)
          goto yyfl_239_1_7_1_1_2;
        goto yysl_239_1_7_1_1;
      yyfl_239_1_7_1_1_2:;
        goto yyfl_239_1_7_1;
      yysl_239_1_7_1_1:;
...
Code_PrintRoutine(yyin_1, yyin_2, yyin_3) yy yyin_1;
yy yyin_2;
yy yyin_3;
{
  {
    ...
    nl();
    {
      yy yysb = yyb;
      {
        ...
        yy_7_1_1_1_1_2 = yy_7_1_1_1_1_1;
        if (yy_7_1_1_1_1_2[0] != 2)
          goto yyfl_240_1_7_1_1_1;
        goto yysl_240_1_7_1_1;
      yyfl_240_1_7_1_1_1:;
        yy_7_1_1_2_1_1 = yyv_Kind;
        yy_7_1_1_2_1_2 = yy_7_1_1_2_1_1;
        if (yy_7_1_1_2_1_2[0] != 2)
          goto yyfl_240_1_7_1_1_2;
        goto yysl_240_1_7_1_1;
      yyfl_240_1_7_1_1_2:;
        goto yyfl_240_1_7_1;
      yysl_240_1_7_1_1:;
...
Code_BroadcastRoutine(yyin_1, yyin_2, yyin_3) yy yyin_1;
yy yyin_2;
yy yyin_3;
{
  {
    ...
    nl();
    {
      yy yysb = yyb;
      {
        ...
        if (yy_17_1_1_1_1_2[0] != 2)
          goto yyfl_241_1_17_1_1_1;
        goto yysl_241_1_17_1_1;
      yyfl_241_1_17_1_1_1:;
        yy_17_1_1_2_1_1 = yyv_Kind;
        yy_17_1_1_2_1_2 = yy_17_1_1_2_1_1;
        if (yy_17_1_1_2_1_2[0] != 2)
          goto yyfl_241_1_17_1_1_2;
        goto yysl_241_1_17_1_1;
      yyfl_241_1_17_1_1_2:;
...
Code_EQCases(yyin_1, yyin_2) yy yyin_1;
yy yyin_2;
{
  {
    yy yyb;
...
Code_PrintCases(yyin_1, yyin_2) yy yyin_1;
yy yyin_2;
{
  {
    yy yyb;
...
Code_BroadcastCases(yyin_1, yyin_2) yy yyin_1;
yy yyin_2;
{
  {
    yy yyb;
...
Code_EQFields(yyin_1, yyin_2) yy yyin_1;
yy yyin_2;
{
  {
    yy yyb;
    ...
    yyv_Type = yy_1_2_2;
    {
      yy yysb = yyb;
      {
        ...
        if (!IsIdent(yy_2_1_1_1_1_1, yy_2_1_1_1_1_2))
          goto yyfl_245_1_2_1_1_1;
        goto yysl_245_1_2_1_1;
      yyfl_245_1_2_1_1_1:;
        yy_2_1_1_2_1_1 = yyv_Type;
        yy_2_1_1_2_1_2 = ((yy) "POS");
        if (!IsIdent(yy_2_1_1_2_1_1, yy_2_1_1_2_1_2))
          goto yyfl_245_1_2_1_1_2;
        goto yysl_245_1_2_1_1;
      yyfl_245_1_2_1_1_2:;
        goto yyfl_245_1_2_1;
      yysl_245_1_2_1_1:;
    ...
    yyfl_245_1_2_1:;
      ...
      if (!IsIdent(yy_2_2_1_1, yy_2_2_1_2))
        goto yyfl_245_1_2_2;
...
Code_PrintFields(yyin_1, yyin_2) yy yyin_1;
yy yyin_2;
{
  {
    yy yyb;
    ...
    yyv_N = yy_0_2;
    {
      ...
      yy_1_1_1_1 = yyv_N;
      yy_1_1_1_2 = ((yy)1);
      if ((long)yy_1_1_1_1 != (long)yy_1_1_1_2)
        goto yyfl_246_1_1_1;
...
Code_BroadcastFields(yyin_1, yyin_2, yyin_3, yyin_4) yy yyin_1;
yy yyin_2;
yy yyin_3;
yy yyin_4;
{
  {
    ...
    yyv_Type = yy_1_2_2;
    {
      ...
      yy_2_1_2_1 = yyv_Type;
      yy_2_1_2_2 = yyv_Int;
      if (!yyeq_IDENT(yy_2_1_2_1, yy_2_1_2_2))
        goto yyfl_247_1_2_1;
      yy_2_1_3_1 = yyv_Tail;
      yy_2_1_3_2_1 = yyv_N;
      yy_2_1_3_2_2 = ((yy)1);
    ...
    yyfl_247_1_2_1:;
      ...
      yy_2_2_2_1 = yyv_Type;
      yy_2_2_2_2 = yyv_Pos;
      if (!yyeq_IDENT(yy_2_2_2_1, yy_2_2_2_2))
        goto yyfl_247_1_2_2;
      yy_2_2_3_1 = yyv_Tail;
      yy_2_2_3_2_1 = yyv_N;
      yy_2_2_3_2_2 = ((yy)1);
    ...
    yyfl_247_1_2_2:;
      ...
      if (!yyeq_IDENT(yy_2_3_2_1, yy_2_3_2_2))
        goto yyfl_247_1_2_3;
      yy_2_3_3_1 = yyv_Tail;
      yy_2_3_3_2_1 = yyv_N;
      yy_2_3_3_2_2 = ((yy)1);
    ...
    yyfl_247_1_2_3:;
      yy_2_4_1_1 = yyv_Type;
      if (!GetGlobalMeaning(yy_2_4_1_1, &yy_2_4_1_2))
        goto yyfl_247_1_2_4;
      if (yy_2_4_1_2[0] != 3)
        goto yyfl_247_1_2_4;
...
Code_DECLARATION(yyin_1) yy yyin_1;
{
  ...
  }
  {
    ...
    }
    {
        ...
        goto yyfl_248_5_2_1;
      {
        ...
        if (yy_2_1_2_1_1_2[0] != 2)
          goto yyfl_248_5_2_1_2_1;
      ...
      yyfl_248_5_2_1_2_1:;
        ...
        if (yy_2_1_2_2_1_2[0] != 1)
          goto yyfl_248_5_2_1_2_2;
        ...
        yyv_Tail = yy_2_1_2_2_1_2_3;
        {
          ...
          if (yy_2_1_2_2_2_1_1_2[0] != 1)
            goto yyfl_248_5_2_1_2_2_2_1;
          ...
          if (!yyeq_IDENT(yy_2_1_2_2_2_1_3_1, yy_2_1_2_2_2_1_3_2))
            goto yyfl_248_5_2_1_2_2_2_1;
          goto yysl_248_5_2_1_2_2_2;
        yyfl_248_5_2_1_2_2_2_1:;
          yy_2_1_2_2_2_2_1_1 =
              ((yy) "type of primary argument must be specified as 'ANY'");
        ...
        }
        {
          ...
          if (yy_2_1_2_2_3_1_1_2[0] != 2)
            goto yyfl_248_5_2_1_2_2_3_1;
          {
            yy yysb = yyb;
            yy_2_1_2_2_3_1_2_1_1_1 = yyv_OutArgs;
            yy_2_1_2_2_3_1_2_1_1_2 = yy_2_1_2_2_3_1_2_1_1_1;
            if (yy_2_1_2_2_3_1_2_1_1_2[0] != 2)
              goto yyfl_248_5_2_1_2_2_3_1_2_1;
            goto yysl_248_5_2_1_2_2_3_1_2;
          yyfl_248_5_2_1_2_2_3_1_2_1:;
            yy_2_1_2_2_3_1_2_2_1_1 =
                ((yy) "output argument requires input argument of same type");
        ...
        yyfl_248_5_2_1_2_2_3_1:;
          ...
          if (yy_2_1_2_2_3_2_1_2[0] != 1)
            goto yyfl_248_5_2_1_2_2_3_2;
          ...
          if (yy_2_1_2_2_3_2_1_2_3[0] != 2)
            goto yyfl_248_5_2_1_2_2_3_2;
          {
            yy yysb = yyb;
            yy_2_1_2_2_3_2_2_1_1_1 = yyv_OutArgs;
            yy_2_1_2_2_3_2_2_1_1_2 = yy_2_1_2_2_3_2_2_1_1_1;
            if (yy_2_1_2_2_3_2_2_1_1_2[0] != 2)
              goto yyfl_248_5_2_1_2_2_3_2_2_1;
          ...
          yyfl_248_5_2_1_2_2_3_2_2_1:;
            ...
            if (yy_2_1_2_2_3_2_2_2_1_2[0] != 1)
              goto yyfl_248_5_2_1_2_2_3_2_2_2;
            ...
            if (yy_2_1_2_2_3_2_2_2_1_2_1[0] != 1)
              goto yyfl_248_5_2_1_2_2_3_2_2_2;
            ...
            if (yy_2_1_2_2_3_2_2_2_1_2_3[0] != 2)
              goto yyfl_248_5_2_1_2_2_3_2_2_2;
            {
              yy yysb = yyb;
              yy_2_1_2_2_3_2_2_2_2_1_1_1 = yyv_T1;
              yy_2_1_2_2_3_2_2_2_2_1_1_2 = yyv_T2;
              if (!yyeq_IDENT(yy_2_1_2_2_3_2_2_2_2_1_1_1,
                              yy_2_1_2_2_3_2_2_2_2_1_1_2))
                goto yyfl_248_5_2_1_2_2_3_2_2_2_2_1;
            ...
            yyfl_248_5_2_1_2_2_3_2_2_2_2_1:;
              ...
              MESSAGE2(yy_2_1_2_2_3_2_2_2_2_2_1_1, yy_2_1_2_2_3_2_2_2_2_2_1_2,
                       yy_2_1_2_2_3_2_2_2_2_2_1_3, yy_2_1_2_2_3_2_2_2_2_2_1_4,
                       yy_2_1_2_2_3_2_2_2_2_2_1_5, yy_2_1_2_2_3_2_2_2_2_2_1_6);
              goto yysl_248_5_2_1_2_2_3_2_2_2_2;
    ...
    yyfl_248_5_6_1:;
      ...
      yy_6_2_1_3 = ((yy) "yyin_");
      yy_6_2_1_4 = ((yy) "");
      ListFormalParams(yy_6_2_1_1, yy_6_2_1_2, yy_6_2_1_3, yy_6_2_1_4,
                       &yy_6_2_1_5);
      yyv_Sep = yy_6_2_1_5;
      ...
      yy_6_2_2_4 = yyv_Sep;
      ListFormalParams(yy_6_2_2_1, yy_6_2_2_2, yy_6_2_2_3, yy_6_2_2_4,
                       &yy_6_2_2_5);
    ...
    yyglov_currentFailLabelUsed = yy_13;
    {
      ...
      yy_14_1_6_5 = ((yy)1);
      Code_RuleGroups(yy_14_1_6_1, yy_14_1_6_2, yy_14_1_6_3, yy_14_1_6_4,
                      yy_14_1_6_5);
    ...
    yyfl_248_5_14_1:;
      ...
      yy_14_2_2_6 = ((yy)1);
      Code_Rules(yy_14_2_2_1, yy_14_2_2_2, yy_14_2_2_3, yy_14_2_2_4,
                 yy_14_2_2_5, yy_14_2_2_6, &yy_14_2_2_7);
      yyv_MayFail = yy_14_2_2_7;
      {
        yy yysb = yyb;
        if (!TraceOption())
          goto yyfl_248_5_14_2_3_1;
      ...
      }
      {
        ...
        if (yy_14_2_4_1_1_2[0] != 1)
          goto yyfl_248_5_14_2_4_1;
  ...
  }
  {
    ...
    s(yy_7_1);
    nl();
    yy_9_1 = ((yy) "char *GENTLE = \"Gentle 3.0 (C) 1992, 1997\";");
    s(yy_9_1);
    nl();
    ...
    nl();
    yy_13_1 = ((
        yy) "{ printf(\"INCONSISTENT GENTLE RUNTIME SYSTEM\\n\"); exit(1); }");
    s(yy_13_1);
    nl();
    yy_15_1 = ((yy) "yyExtend();");
    s(yy_15_1);
...
Declare_broadcast_Procs(yyin_1) yy yyin_1;
{
  {
    yy yyb;
    yy yy_0_1;
...
CollectSweepRules(yyin_1, yyout_1) yy yyin_1;
yy *yyout_1;
{
  {
    yy yyb;
...
InspectSweepRule(yyin_1, yyin_2, yyout_1) yy yyin_1;
yy yyin_2;
yy *yyout_1;
{
  {
    ...
    yyv_Type = yy_1_2;
    {
      ...
      if (!AddedSweepRule(yy_2_1_1_1, yy_2_1_1_2, yy_2_1_1_3))
        goto yyfl_254_1_2_1;
...
GetSweepType(yyin_1, yyout_1) yy yyin_1;
yy *yyout_1;
{
  {
    yy yyb;
    ...
    yyv_Out = yy_0_1_1_4;
    {
      ...
      yyv_Head = yy_1_1_1_2_1;
      {
        yy yysb = yyb;
        {
          ...
          if (yy_1_1_2_1_1_1_1_2[0] != 4)
            goto yyfl_255_1_1_1_2_1_1_1;
        ...
        yyfl_255_1_1_1_2_1_1_1:;
          ...
          if (yy_1_1_2_1_1_2_1_2[0] != 1)
            goto yyfl_255_1_1_1_2_1_1_2;
        ...
        }
        {
          ...
          if (!GetFunctorMeaning(yy_1_1_2_1_2_1_1_1, &yy_1_1_2_1_2_1_1_2))
            goto yyfl_255_1_1_1_2_1_2_1;
          if (yy_1_1_2_1_2_1_1_2[0] != 1)
            goto yyfl_255_1_1_1_2_1_2_1;
          yy_1_1_2_1_2_1_1_2_1 = ((yy)yy_1_1_2_1_2_1_1_2[1]);
          yy_1_1_2_1_2_1_1_2_2 = ((yy)yy_1_1_2_1_2_1_1_2[2]);
          yyv_Type = yy_1_1_2_1_2_1_1_2_1;
          if (yy_1_1_2_1_2_1_1_2_2[0] != 2)
            goto yyfl_255_1_1_1_2_1_2_1;
          goto yysl_255_1_1_1_2_1_2;
        yyfl_255_1_1_1_2_1_2_1:;
          yy_1_1_2_1_2_2_1_1 = yyv_Functor;
          if (!GetFunctorMeaning(yy_1_1_2_1_2_2_1_1, &yy_1_1_2_1_2_2_1_2))
            goto yyfl_255_1_1_1_2_1_2_2;
          if (yy_1_1_2_1_2_2_1_2[0] != 1)
            goto yyfl_255_1_1_1_2_1_2_2;
          ...
          MESSAGE1(yy_1_1_2_1_2_2_2_1, yy_1_1_2_1_2_2_2_2, yy_1_1_2_1_2_2_2_3,
                   yy_1_1_2_1_2_2_2_4);
          goto yysl_255_1_1_1_2_1_2;
        yyfl_255_1_1_1_2_1_2_2:;
          ...
          MESSAGE1(yy_1_1_2_1_2_3_1_1, yy_1_1_2_1_2_3_1_2, yy_1_1_2_1_2_3_1_3,
                   yy_1_1_2_1_2_3_1_4);
          yy_1_1_2_1_2_3_2 = yyglov_id_INT;
          if (yy_1_1_2_1_2_3_2 == (yy)yyu)
            yyErr(1, 2383);
      ...
      yyfl_255_1_1_1_2_1:;
        ...
        if (yy_1_1_2_2_1_2[0] != 2)
          goto yyfl_255_1_1_1_2_2;
...
int AddedSweepRule(yyin_1, yyin_2, yyin_3) yy yyin_1;
yy yyin_2;
yy yyin_3;
{
  {
    ...
    yyfl_256_1_2_1:;
      ...
      yy_2_2_1_2 = yyv_Type;
      yy_2_2_1_3 = yyv_Tail;
      if (!AddedSweepRule(yy_2_2_1_1, yy_2_2_1_2, yy_2_2_1_3))
        goto yyfl_256_1_2_2;
      goto yysl_256_1_2;
    yyfl_256_1_2_2:;
      goto yyfl_256_1;
...
Code_RuleGroups(yyin_1, yyin_2, yyin_3, yyin_4, yyin_5) yy yyin_1;
yy yyin_2;
yy yyin_3;
yy yyin_4;
yy yyin_5;
{
  {
    ...
    nl();
    {
      ...
      yy_5_1_1_1 = yyv_N;
      yy_5_1_1_2 = ((yy)1);
      if ((long)yy_5_1_1_1 != (long)yy_5_1_1_2)
        goto yyfl_257_1_5_1;
      yy_5_1_2_1 = ((yy) "if ");
      s(yy_5_1_2_1);
      goto yysl_257_1_5;
    ...
    yy_6_1 = ((yy) "(yytp == (long) yybroadcast_");
    s(yy_6_1);
    yy_7_1 = yyv_Type;
    id(yy_7_1);
    yy_8_1 = ((yy) ") {");
...
Check_UniqueIds(yyin_1, yyin_2) yy yyin_1;
yy yyin_2;
{
  {
    yy yyb;
...
Check_UniqueId(yyin_1, yyin_2, yyin_3) yy yyin_1;
yy yyin_2;
yy yyin_3;
{
  {
...
CheckFunctors(yyin_1) yy yyin_1;
{
  {
    yy yyb;
    yy yy_0_1;
...
CheckFunctor(yyin_1, yyin_2) yy yyin_1;
yy yyin_2;
{
  {
    yy yyb;
...
CheckFunctorArgs(yyin_1) yy yyin_1;
{
  {
    yy yyb;
    yy yy_0_1;
...
CheckFunctorArg(yyin_1, yyin_2, yyin_3) yy yyin_1;
yy yyin_2;
yy yyin_3;
{
  {
...
CheckUniqueArgName(yyin_1, yyin_2, yyin_3) yy yyin_1;
yy yyin_2;
yy yyin_3;
{
  {
    ...
    yyv_Pos = yy_0_3;
    {
      ...
      yy_1_1_3_1 = yyv_Id1;
      yy_1_1_3_2 = yyv_Id2;
      if (!yyeq_IDENT(yy_1_1_3_1, yy_1_1_3_2))
        goto yyfl_264_1_1_1;
      yy_1_1_4_1 = ((yy) "'");
      yy_1_1_4_2 = yyv_Id1;
...
CheckIdNotInFunctorSpecs(yyin_1, yyin_2) yy yyin_1;
yy yyin_2;
{
  {
    yy yyb;
...
CheckUniqueFunctor(yyin_1, yyin_2, yyin_3) yy yyin_1;
yy yyin_2;
yy yyin_3;
{
  {
...
int ProcOrCond(yyin_1) yy yyin_1;
{
  {
    yy yyb;
    yy yy_0_1;
...
CheckFormalParams(yyin_1, yyin_2) yy yyin_1;
yy yyin_2;
{
  {
    yy yyb;
...
CheckFormalParamList(yyin_1) yy yyin_1;
{
  {
    yy yyb;
    yy yy_0_1;
...
CheckFormalParam(yyin_1, yyin_2) yy yyin_1;
yy yyin_2;
{
  {
    yy yyb;
...
CheckUniqueParams(yyin_1, yyin_2) yy yyin_1;
yy yyin_2;
{
  {
    yy yyb;
...
CheckUniqueParam(yyin_1, yyin_2, yyin_3, yyin_4) yy yyin_1;
yy yyin_2;
yy yyin_3;
yy yyin_4;
{
...
CheckIdNotInParamList(yyin_1, yyin_2) yy yyin_1;
yy yyin_2;
{
  {
    yy yyb;
...
CheckParamNamesDiffer(yyin_1, yyin_2, yyin_3) yy yyin_1;
yy yyin_2;
yy yyin_3;
{
  {
...
ReturnFalse(yyin_1, yyin_2) yy yyin_1;
yy yyin_2;
{
  {
    yy yyb;
...
ListFormalParams(yyin_1, yyin_2, yyin_3, yyin_4, yyout_1) yy yyin_1;
yy yyin_2;
yy yyin_3;
yy yyin_4;
yy *yyout_1;
...
DeclareFormalParams(yyin_1, yyin_2, yyin_3) yy yyin_1;
yy yyin_2;
yy yyin_3;
{
  {
...
Code_Rules(yyin_1, yyin_2, yyin_3, yyin_4, yyin_5, yyin_6, yyout_1) yy yyin_1;
yy yyin_2;
yy yyin_3;
yy yyin_4;
yy yyin_5;
...
Code_Rule(yyin_1, yyin_2, yyin_3, yyin_4, yyin_5, yyin_6, yyout_1) yy yyin_1;
yy yyin_2;
yy yyin_3;
yy yyin_4;
yy yyin_5;
...
{
  {
    ...
    AssignOutAttr(yy_20_1, yy_20_2);
    {
      ...
      yy_21_1_1_2 = ((yy)0);
      if ((long)yy_21_1_1_1 != (long)yy_21_1_1_2)
        goto yyfl_280_1_21_1;
        ...
        goto yyfl_280_2_12_1;
      {
        ...
        yyv_FIA_Tail = yy_12_1_2_1_2_2_3;
        {
          yy yysb = yyb;
          {
            ...
            if (yy_12_1_2_1_3_1_1_1_1_2[0] != 4)
              goto yyfl_280_2_12_1_2_1_3_1_1_1;
            ...
            if (yy_12_1_2_1_3_1_1_1_1_2_4[0] != 1)
              goto yyfl_280_2_12_1_2_1_3_1_1_1;
          ...
          yyfl_280_2_12_1_2_1_3_1_1_1:;
            ...
            if (yy_12_1_2_1_3_1_1_2_1_2[0] != 1)
              goto yyfl_280_2_12_1_2_1_3_1_1_2;
          ...
          }
          {
            ...
            if (!GetFunctorMeaning(yy_12_1_2_1_3_1_2_1_1_1,
                                   &yy_12_1_2_1_3_1_2_1_1_2))
              goto yyfl_280_2_12_1_2_1_3_1_2_1;
            if (yy_12_1_2_1_3_1_2_1_1_2[0] != 1)
              goto yyfl_280_2_12_1_2_1_3_1_2_1;
            ...
            if (yy_12_1_2_1_3_1_2_1_1_2_2[0] != 2)
              goto yyfl_280_2_12_1_2_1_3_1_2_1;
            goto yysl_280_2_12_1_2_1_3_1_2;
          yyfl_280_2_12_1_2_1_3_1_2_1:;
            yy_12_1_2_1_3_1_2_2_1_1 = yyv_Functor1;
            if (!GetFunctorMeaning(yy_12_1_2_1_3_1_2_2_1_1,
                                   &yy_12_1_2_1_3_1_2_2_1_2))
              goto yyfl_280_2_12_1_2_1_3_1_2_2;
            if (yy_12_1_2_1_3_1_2_2_1_2[0] != 1)
              goto yyfl_280_2_12_1_2_1_3_1_2_2;
            ...
            MESSAGE1(yy_12_1_2_1_3_1_2_2_2_1, yy_12_1_2_1_3_1_2_2_2_2,
                     yy_12_1_2_1_3_1_2_2_2_3, yy_12_1_2_1_3_1_2_2_2_4);
            goto yysl_280_2_12_1_2_1_3_1_2;
          yyfl_280_2_12_1_2_1_3_1_2_2:;
            ...
            MESSAGE1(yy_12_1_2_1_3_1_2_3_1_1, yy_12_1_2_1_3_1_2_3_1_2,
                     yy_12_1_2_1_3_1_2_3_1_3, yy_12_1_2_1_3_1_2_3_1_4);
            yy_12_1_2_1_3_1_2_3_2 = yyglov_id_INT;
            if (yy_12_1_2_1_3_1_2_3_2 == (yy)yyu)
              yyErr(1, 2714);
        ...
        yyfl_280_2_12_1_2_1_3_1:;
          ...
          if (yy_12_1_2_1_3_2_1_2[0] != 2)
            goto yyfl_280_2_12_1_2_1_3_2;
...
PosDefiningMember(yyin_1, yyin_2, yyin_3, yyout_1) yy yyin_1;
yy yyin_2;
yy yyin_3;
yy *yyout_1;
{
...
CheckEqId(yyin_1, yyin_2, yyin_3) yy yyin_1;
yy yyin_2;
yy yyin_3;
{
  {
    ...
    yyfl_282_1_1_1:;
      ...
      yy_1_2_1_5 = ((yy) "'");
      yy_1_2_1_6 = yyv_Pos;
      MESSAGE2(yy_1_2_1_1, yy_1_2_1_2, yy_1_2_1_3, yy_1_2_1_4, yy_1_2_1_5,
               yy_1_2_1_6);
      goto yysl_282_1_1;
    yysl_282_1_1:;
      yyb = yysb;
...
UndeclarelocalVars(yyin_1) yy yyin_1;
{
  {
    yy yyb;
    yy yy_0_1;
...
UndeclareLocalVar(yyin_1) yy yyin_1;
{
  {
    yy yyb;
    yy yyv_Id;
...
AssignInArgs(yyin_1, yyin_2) yy yyin_1;
yy yyin_2;
{
  {
    yy yyb;
...
AssignInArg(yyin_1, yyin_2) yy yyin_1;
yy yyin_2;
{
  {
    yy yyb;
...
AssignOutArgs(yyin_1, yyin_2) yy yyin_1;
yy yyin_2;
{
  {
    yy yyb;
...
AssignOutArg(yyin_1, yyin_2) yy yyin_1;
yy yyin_2;
{
  {
    yy yyb;
...
SplitMembers(yyin_1, yyout_1, yyout_2) yy yyin_1;
yy *yyout_1;
yy *yyout_2;
{
  {
...
SplitMemberlist(yyin_1, yyout_1, yyout_2) yy yyin_1;
yy *yyout_1;
yy *yyout_2;
{
  {
...
int IsSourceSymbol(yyin_1) yy yyin_1;
{
  {
    yy yyb;
    yy yyv_Id;
    ...
    yyv_Id = yy_0_1;
    yy_1_1 = yyv_Id;
    if (!GetGlobalMeaning(yy_1_1, &yy_1_2))
      goto yyfl_297_1;
    if (yy_1_2[0] != 4)
      goto yyfl_297_1;
    yy_1_2_1 = ((yy)yy_1_2[1]);
...
CheckNoGrammar_MEMBERS(yyin_1) yy yyin_1;
{
  {
    yy yyb;
    yy yy_0_1;
...
CheckNoGrammar_MEMBERLIST(yyin_1) yy yyin_1;
{
  {
    yy yyb;
    yy yy_0_1;
...
CheckNoGrammar_MEMBER(yyin_1) yy yyin_1;
{
  {
    yy yyb;
    yy yy_0_1;
...
CheckNoGrammar_ALTERNATIVELIST(yyin_1) yy yyin_1;
{
  {
    yy yyb;
    yy yy_0_1;
...
Code_GrammarSymbols(yyin_1) yy yyin_1;
{
  {
    yy yyb;
    yy yy_0_1;
...
AssignAttributes(yyin_1, yyin_2, yyin_3) yy yyin_1;
yy yyin_2;
yy yyin_3;
{
  {
  ...
  }
  {
    ...
    yyv_DefMem = yy_0_3;
    {
      ...
      yyv_P2 = yy_1_1_2_2_3;
      {
        ...
        yy_1_1_3_1_1_2 = ((yy)0);
        if ((long)yy_1_1_3_1_1_1 != (long)yy_1_1_3_1_1_2)
          goto yyfl_303_2_1_1_3_1;
...
AssignAttributes_DEFARGLIST(yyin_1, yyin_2) yy yyin_1;
yy yyin_2;
{
  {
    yy yyb;
...
AssignOutAttr(yyin_1, yyin_2) yy yyin_1;
yy yyin_2;
{
  {
    yy yyb;
...
Code_Members(yyin_1, yyin_2, yyin_3) yy yyin_1;
yy yyin_2;
yy yyin_3;
{
  {
...
Code_Memberlist(yyin_1, yyin_2) yy yyin_1;
yy yyin_2;
{
  {
    yy yyb;
...
Code_Member(yyin_1, yyin_2) yy yyin_1;
yy yyin_2;
{
  {
    yy yyb;
  ...
  }
  {
    ...
    yyv_Tmp = yy_0_2;
    {
        ...
        goto yyfl_312_2_1_1;
      {
        yy yysb = yyb;
        {
          ...
          if (!IsIdent(yy_1_1_2_1_1_1_1_1, yy_1_1_2_1_1_1_1_2))
            goto yyfl_312_2_1_1_2_1_1_1;
          goto yysl_312_2_1_1_2_1_1;
        yyfl_312_2_1_1_2_1_1_1:;
          yy_1_1_2_1_1_2_1_1 = yyv_Predicate;
          yy_1_1_2_1_1_2_1_2 = ((yy) "val");
          if (!IsIdent(yy_1_1_2_1_1_2_1_1, yy_1_1_2_1_1_2_1_2))
            goto yyfl_312_2_1_1_2_1_1_2;
          goto yysl_312_2_1_1_2_1_1;
        yyfl_312_2_1_1_2_1_1_2:;
          yy_1_1_2_1_1_3_1_1 = yyv_Predicate;
          yy_1_1_2_1_1_3_1_2 = ((yy) "where");
          if (!IsIdent(yy_1_1_2_1_1_3_1_1, yy_1_1_2_1_1_3_1_2))
            goto yyfl_312_2_1_1_2_1_1_3;
          goto yysl_312_2_1_1_2_1_1;
        yyfl_312_2_1_1_2_1_1_3:;
          yy_1_1_2_1_1_4_1_1 = yyv_Predicate;
          yy_1_1_2_1_1_4_1_2 = ((yy) "let");
          if (!IsIdent(yy_1_1_2_1_1_4_1_1, yy_1_1_2_1_1_4_1_2))
            goto yyfl_312_2_1_1_2_1_1_4;
          goto yysl_312_2_1_1_2_1_1;
      ...
      yyfl_312_2_1_1_2_1:;
        ...
        if (!IsIdent(yy_1_1_2_2_1_1, yy_1_1_2_2_1_2))
          goto yyfl_312_2_1_1_2_2;
        {
          yy yysb = yyb;
          yyb = yyh;
          yyh += 6;
          ...
          if (yy_1_1_2_2_2_1_1_2[0] != 1)
            goto yyfl_312_2_1_1_2_2_2_1;
          ...
          yy_1_1_2_2_2_1_2_2_3_1 = ((yy)yy_1_1_2_2_2_1_2_2_3[1]);
          {
            ...
            if (yy_1_1_2_2_2_1_3_1_1_2[0] != 3)
              goto yyfl_312_2_1_1_2_2_2_1_3_1;
            ...
            yyv_POutVar = yy_1_1_2_2_2_1_3_1_1_2_3;
            {
              ...
              if (!GetLocalMeaning(yy_1_1_2_2_2_1_3_1_2_1_1_1,
                                   &yy_1_1_2_2_2_1_3_1_2_1_1_2))
                goto yyfl_312_2_1_1_2_2_2_1_3_1_2_1;
            ...
            yyfl_312_2_1_1_2_2_2_1_3_1_2_1:;
              ...
              MESSAGE1(yy_1_1_2_2_2_1_3_1_2_2_1_1, yy_1_1_2_2_2_1_3_1_2_2_1_2,
                       yy_1_1_2_2_2_1_3_1_2_2_1_3, yy_1_1_2_2_2_1_3_1_2_2_1_4);
              yy_1_1_2_2_2_1_3_1_2_2_2 = yyglov_id_INT;
              if (yy_1_1_2_2_2_1_3_1_2_2_2 == (yy)yyu)
                yyErr(1, 3099);
      ...
      yyfl_312_2_1_1_2_2:;
        ...
        if (!IsIdent(yy_1_1_2_3_1_1, yy_1_1_2_3_1_2))
          goto yyfl_312_2_1_1_2_3;
        {
          yy yysb = yyb;
          yyb = yyh;
          yyh += 6;
          ...
          if (yy_1_1_2_3_2_1_1_2[0] != 1)
            goto yyfl_312_2_1_1_2_3_2_1;
      ...
      yyfl_312_2_1_1_2_4:;
        ...
        if (!IsRelation(yy_1_1_2_5_1_1))
          goto yyfl_312_2_1_1_2_5;
        {
          yy yysb = yyb;
          yyb = yyh;
          yyh += 12;
          ...
          if (yy_1_1_2_5_2_1_1_2[0] != 1)
            goto yyfl_312_2_1_1_2_5_2_1;
          ...
          yyv_T2 = yy_1_1_2_5_2_1_6_2;
          {
            yy yysb = yyb;
            {
              ...
              if (!IsIdent(yy_1_1_2_5_2_1_7_1_1_1_1_1,
                           yy_1_1_2_5_2_1_7_1_1_1_1_2))
                goto yyfl_312_2_1_1_2_5_2_1_7_1_1_1;
            ...
            yyfl_312_2_1_1_2_5_2_1_7_1_1_1:;
              ...
              if (!IsIdent(yy_1_1_2_5_2_1_7_1_1_2_1_1,
                           yy_1_1_2_5_2_1_7_1_1_2_1_2))
                goto yyfl_312_2_1_1_2_5_2_1_7_1_1_2;
              goto yysl_312_2_1_1_2_5_2_1_7_1_1;
            ...
            yy_1_1_2_5_2_1_7_1_2_1 = ((yy) "if ((long)");
            ...
            yy_1_1_2_5_2_1_7_1_5_1 = ((yy) "(long)");
          ...
          yyfl_312_2_1_1_2_5_2_1_7_1:;
            ...
            if (!IsIdent(yy_1_1_2_5_2_1_7_2_1_1, yy_1_1_2_5_2_1_7_2_1_2))
              goto yyfl_312_2_1_1_2_5_2_1_7_2;
          ...
          yyfl_312_2_1_1_2_5_2_1_7_2:;
            {
              ...
              if (!IsIdent(yy_1_1_2_5_2_1_7_3_1_1_1_1,
                           yy_1_1_2_5_2_1_7_3_1_1_1_2))
                goto yyfl_312_2_1_1_2_5_2_1_7_3_1_1;
            ...
            yyfl_312_2_1_1_2_5_2_1_7_3_1_1:;
              ...
              if (!IsIdent(yy_1_1_2_5_2_1_7_3_1_2_1_1,
                           yy_1_1_2_5_2_1_7_3_1_2_1_2))
                goto yyfl_312_2_1_1_2_5_2_1_7_3_1_2;
            ...
            yyfl_312_2_1_1_2_5_2_1_7_3_1_2:;
              yy_1_1_2_5_2_1_7_3_1_3_1_1 =
                  ((yy) "relation not defined for type '");
              yy_1_1_2_5_2_1_7_3_1_3_1_2 = yyv_Type;
              yy_1_1_2_5_2_1_7_3_1_3_1_3 = ((yy) "'");
              yy_1_1_2_5_2_1_7_3_1_3_1_4 = yyv_Pos;
              MESSAGE1(yy_1_1_2_5_2_1_7_3_1_3_1_1, yy_1_1_2_5_2_1_7_3_1_3_1_2,
                       yy_1_1_2_5_2_1_7_3_1_3_1_3, yy_1_1_2_5_2_1_7_3_1_3_1_4);
              goto yysl_312_2_1_1_2_5_2_1_7_3_1;
    ...
    yyfl_312_2_1_2:;
      ...
      yy_1_3_1_3 = yyv_Pos;
      if (!IsPredicate(yy_1_3_1_1, yy_1_3_1_2, yy_1_3_1_3, &yy_1_3_1_4,
                       &yy_1_3_1_5, &yy_1_3_1_6, &yy_1_3_1_7))
        goto yyfl_312_2_1_3;
      ...
      yyfl_312_2_1_3_2_1:;
        ...
        if (!ProcOrCond(yy_1_3_2_2_1_1))
          goto yyfl_312_2_1_3_2_2;
      ...
      yyfl_312_2_1_3_2_2:;
        ...
        if (yy_1_3_2_3_1_2[0] != 6)
          goto yyfl_312_2_1_3_2_3;
        {
          yy yysb = yyb;
          yyb = yyh;
          yyh += 6;
          ...
          if (yy_1_3_2_3_2_1_1_2[0] != 1)
            goto yyfl_312_2_1_3_2_3_2_1;
        ...
        }
        {
          ...
          if (yy_1_3_2_3_3_1_1_2[0] != 1)
            goto yyfl_312_2_1_3_2_3_3_1;
        ...
        s(yy_1_3_2_3_13_1);
        {
          ...
          if (yy_1_3_2_3_14_1_1_2[0] != 1)
            goto yyfl_312_2_1_3_2_3_14_1;
        ...
        yyfl_312_2_1_3_2_3_14_1:;
          ...
          ListInArgs(yy_1_3_2_3_14_2_1_1, yy_1_3_2_3_14_2_1_2,
                     &yy_1_3_2_3_14_2_1_3);
        ...
        }
        {
          ...
          if (yy_1_3_2_3_15_1_1_2[0] != 2)
            goto yyfl_312_2_1_3_2_3_15_1;
      ...
      yyfl_312_2_1_3_2_3:;
        ...
        if (yy_1_3_2_4_1_2[0] != 5)
          goto yyfl_312_2_1_3_2_4;
...
int IsRelation(yyin_1) yy yyin_1;
{
  {
    yy yyb;
    yy yyv_Id;
    ...
    yyfl_313_1_2_1:;
      yy_2_2_1_1 = yyv_Str;
      yy_2_2_1_2 = ((yy) "ne");
      if (strcmp((char *)yy_2_2_1_1, (char *)yy_2_2_1_2) != 0)
        goto yyfl_313_1_2_2;
      goto yysl_313_1_2;
    yyfl_313_1_2_2:;
      yy_2_3_1_1 = yyv_Str;
      yy_2_3_1_2 = ((yy) "lt");
      if (strcmp((char *)yy_2_3_1_1, (char *)yy_2_3_1_2) != 0)
        goto yyfl_313_1_2_3;
      goto yysl_313_1_2;
    yyfl_313_1_2_3:;
      yy_2_4_1_1 = yyv_Str;
      yy_2_4_1_2 = ((yy) "le");
      if (strcmp((char *)yy_2_4_1_1, (char *)yy_2_4_1_2) != 0)
        goto yyfl_313_1_2_4;
      goto yysl_313_1_2;
    yyfl_313_1_2_4:;
      yy_2_5_1_1 = yyv_Str;
      yy_2_5_1_2 = ((yy) "gt");
      if (strcmp((char *)yy_2_5_1_1, (char *)yy_2_5_1_2) != 0)
        goto yyfl_313_1_2_5;
      goto yysl_313_1_2;
    yyfl_313_1_2_5:;
      yy_2_6_1_1 = yyv_Str;
      yy_2_6_1_2 = ((yy) "ge");
      if (strcmp((char *)yy_2_6_1_1, (char *)yy_2_6_1_2) != 0)
        goto yyfl_313_1_2_6;
      goto yysl_313_1_2;
    yyfl_313_1_2_6:;
      goto yyfl_313_1;
...
int IsIdent(yyin_1, yyin_2) yy yyin_1;
yy yyin_2;
{
  {
    yy yyb;
    ...
    yy_2_1 = yyv_Str;
    yy_2_2 = yyv_Str2;
    if (strcmp((char *)yy_2_1, (char *)yy_2_2) != 0)
      goto yyfl_314_1;
    return 1;
  yyfl_314_1:;
  }
...
DetermineType(yyin_1, yyout_1) yy yyin_1;
yy *yyout_1;
{
  {
    yy yyb;
  ...
  }
  {
    ...
    yyv_Args = yy_0_1_5;
    {
      ...
      if (!GetFunctorMeaning(yy_1_1_1_1, &yy_1_1_1_2))
        goto yyfl_315_3_1_1;
      if (yy_1_1_1_2[0] != 1)
        goto yyfl_315_3_1_1;
      yy_1_1_1_2_1 = ((yy)yy_1_1_1_2[1]);
    ...
    yyfl_315_3_1_1:;
      ...
      if (!GetFunctorMeaning(yy_1_2_1_1, &yy_1_2_1_2))
        goto yyfl_315_3_1_2;
      if (yy_1_2_1_2[0] != 1)
        goto yyfl_315_3_1_2;
      yy_1_2_1_2_1 = ((yy)yy_1_2_1_2[1]);
  ...
  }
  {
    ...
    yyv_Pos = yy_0_1_3;
    {
      yy yysb = yyb;
      yy_1_1_1_1 = yyv_Name;
      if (!GetLocalMeaning(yy_1_1_1_1, &yy_1_1_1_2))
        goto yyfl_315_5_1_1;
      yyv_Type = yy_1_1_1_2;
      goto yysl_315_5_1;
    yyfl_315_5_1_1:;
...
{
  {
    ...
    yyv_Id = yy_0_1;
    {
      ...
      yy_1_1_1_1 = yyv_Id;
      yy_1_1_1_2 = ((yy) "eq");
      if (!IsIdent(yy_1_1_1_1, yy_1_1_1_2))
        goto yyfl_316_1_1_1;
      yy_1_1_2_1 = ((yy) " != ");
      s(yy_1_1_2_1);
      goto yysl_316_1_1;
    yyfl_316_1_1_1:;
      yy_1_2_1_1 = yyv_Id;
      yy_1_2_1_2 = ((yy) "ne");
      if (!IsIdent(yy_1_2_1_1, yy_1_2_1_2))
        goto yyfl_316_1_1_2;
      yy_1_2_2_1 = ((yy) " == ");
      s(yy_1_2_2_1);
      goto yysl_316_1_1;
    yyfl_316_1_1_2:;
      yy_1_3_1_1 = yyv_Id;
      yy_1_3_1_2 = ((yy) "lt");
      if (!IsIdent(yy_1_3_1_1, yy_1_3_1_2))
        goto yyfl_316_1_1_3;
      yy_1_3_2_1 = ((yy) " >= ");
      s(yy_1_3_2_1);
      goto yysl_316_1_1;
    yyfl_316_1_1_3:;
      yy_1_4_1_1 = yyv_Id;
      yy_1_4_1_2 = ((yy) "le");
      if (!IsIdent(yy_1_4_1_1, yy_1_4_1_2))
        goto yyfl_316_1_1_4;
      yy_1_4_2_1 = ((yy) " > ");
      s(yy_1_4_2_1);
      goto yysl_316_1_1;
    yyfl_316_1_1_4:;
      yy_1_5_1_1 = yyv_Id;
      yy_1_5_1_2 = ((yy) "gt");
      if (!IsIdent(yy_1_5_1_1, yy_1_5_1_2))
        goto yyfl_316_1_1_5;
      yy_1_5_2_1 = ((yy) " <= ");
      s(yy_1_5_2_1);
      goto yysl_316_1_1;
    yyfl_316_1_1_5:;
      yy_1_6_1_1 = yyv_Id;
      yy_1_6_1_2 = ((yy) "ge");
      if (!IsIdent(yy_1_6_1_1, yy_1_6_1_2))
        goto yyfl_316_1_1_6;
      yy_1_6_2_1 = ((yy) " < ");
      s(yy_1_6_2_1);
      goto yysl_316_1_1;
...
InitFields(yyin_1, yyin_2) yy yyin_1;
yy yyin_2;
{
  {
    yy yyb;
...
CheckEmptyInArgs(yyin_1) yy yyin_1;
{
  {
    yy yyb;
    yy yy_0_1;
...
CheckSingleOutArg(yyin_1, yyout_1) yy yyin_1;
yy *yyout_1;
{
  {
    yy yyb;
...
Code_Cases(yyin_1, yyin_2, yyin_3, yyout_1, yyout_2) yy yyin_1;
yy yyin_2;
yy yyin_3;
yy *yyout_1;
yy *yyout_2;
...
Code_Case(yyin_1, yyin_2, yyin_3, yyout_1, yyout_2) yy yyin_1;
yy yyin_2;
yy yyin_3;
yy *yyout_1;
yy *yyout_2;
...
Call(yyin_1, yyin_2, yyin_3, yyin_4) yy yyin_1;
yy yyin_2;
yy yyin_3;
yy yyin_4;
{
  ...
  }
  {
    ...
    yyv_OutArgs = yy_0_4;
    {
      ...
      yyv_Tmp = yy_1_1_8_2;
      {
        ...
        if (yy_1_1_9_1_1 == (yy)yyu)
          yyErr(1, 3503);
        if (yy_1_1_9_1_1[0] != 2)
          goto yyfl_323_3_1_1_9_1;
        yy_1_1_9_1_2_1 = ((yy) "{");
        s(yy_1_1_9_1_2_1);
        nl();
        yy_1_1_9_1_4_1 =
            ((yy) "yy yyCntl; yysave yyCntlSaved; int (* yyfun) ();");
        s(yy_1_1_9_1_4_1);
        nl();
        ...
        nl();
        yy_1_1_9_1_18_1 =
            ((yy) "if (yyfun == (int (*) ()) 0) { yyEndChoice(yyCntlSaved); ");
        s(yy_1_1_9_1_18_1);
        Fail();
        yy_1_1_9_1_20_1 = ((yy) " }");
        s(yy_1_1_9_1_20_1);
      ...
      yyfl_323_3_1_1_9_1:;
        ...
        LookupPath(yy_1_1_9_2_4_1, yy_1_1_9_2_4_2, yy_1_1_9_2_4_3,
                   &yy_1_1_9_2_4_4);
...
MakePath(yyin_1, yyin_2, yyout_1) yy yyin_1;
yy yyin_2;
yy *yyout_1;
{
  {
...
ListInArgs(yyin_1, yyin_2, yyout_1) yy yyin_1;
yy yyin_2;
yy *yyout_1;
{
  {
...
ListOutArgs(yyin_1, yyin_2) yy yyin_1;
yy yyin_2;
{
  {
    yy yyb;
...
int IsPredicate(yyin_1, yyin_2, yyin_3, yyout_1, yyout_2, yyout_3,
                yyout_4) yy yyin_1;
yy yyin_2;
yy yyin_3;
yy *yyout_1;
...
int IdentIsInList(yyin_1, yyin_2) yy yyin_1;
yy yyin_2;
{
  {
    yy yyb;
    ...
    yyfl_332_1_1_1:;
      yy_1_2_1_1 = yyv_Id;
      yy_1_2_1_2 = yyv_Tail;
      if (!IdentIsInList(yy_1_2_1_1, yy_1_2_1_2))
        goto yyfl_332_1_1_2;
      goto yysl_332_1_1;
    yyfl_332_1_1_2:;
      goto yyfl_332_1;
...
int IsVariable(yyin_1, yyout_1) yy yyin_1;
yy *yyout_1;
{
  {
    yy yyb;
...
CheckVariable(yyin_1, yyin_2, yyout_1) yy yyin_1;
yy yyin_2;
yy *yyout_1;
{
  {
...
CheckType(yyin_1, yyin_2) yy yyin_1;
yy yyin_2;
{
  {
    yy yyb;
    ...
    yyfl_336_1_1_1:;
      yy_1_2_1_1 = yyv_Id;
      if (!GetGlobalMeaning(yy_1_2_1_1, &yy_1_2_1_2))
        goto yyfl_336_1_1_2;
      if (yy_1_2_1_2[0] != 3)
        goto yyfl_336_1_1_2;
      yy_1_2_1_2_1 = ((yy)yy_1_2_1_2[1]);
...
CheckTableField(yyin_1, yyin_2, yyin_3, yyin_4, yyout_1, yyout_2) yy yyin_1;
yy yyin_2;
yy yyin_3;
yy yyin_4;
yy *yyout_1;
...
{
  {
    ...
    yyv_Pos = yy_0_4;
    {
      ...
      if (!GetGlobalMeaning(yy_1_1_2_1, &yy_1_1_2_2))
        goto yyfl_337_1_1_1;
      if (yy_1_1_2_2[0] != 1)
        goto yyfl_337_1_1_1;
      yy_1_1_2_2_1 = ((yy)yy_1_1_2_2[1]);
      ...
      yyv_FunctorSpecs = yy_1_1_2_2_2;
      {
        ...
        if (!HasLocalMeaning(yy_1_1_3_1_1_1))
          goto yyfl_337_1_1_1_3_1;
      ...
      yyfl_337_1_1_1_3_1:;
        ...
        MESSAGE1(yy_1_1_3_2_1_1, yy_1_1_3_2_1_2, yy_1_1_3_2_1_3,
                 yy_1_1_3_2_1_4);
        goto yysl_337_1_1_1_3;
      yysl_337_1_1_1_3:;
        yyb = yysb;
      ...
      yy_1_1_4_1 = yyv_Key;
      if (!GetLocalMeaning2(yy_1_1_4_1, &yy_1_1_4_2))
        goto yyfl_337_1_1_1;
      yyv_FunctorCode = yy_1_1_4_2;
      {
        ...
        LookupFieldForAllFunctors(
            yy_1_1_5_1_3_1, yy_1_1_5_1_3_2, yy_1_1_5_1_3_3, yy_1_1_5_1_3_4,
            &yy_1_1_5_1_3_5, &yy_1_1_5_1_3_6, &yy_1_1_5_1_3_7);
      ...
      yyfl_337_1_1_1_5_1:;
        ...
        yy_1_1_5_2_1_3 = ((yy)1);
        GetFunctorSpecForCode(yy_1_1_5_2_1_1, yy_1_1_5_2_1_2, yy_1_1_5_2_1_3,
                              &yy_1_1_5_2_1_4);
        yyv_FunctorSpec = yy_1_1_5_2_1_4;
        yy_1_1_5_2_2_2 = yyv_FunctorSpec;
        yy_1_1_5_2_2_1 = yy_1_1_5_2_2_2;
        if (yy_1_1_5_2_2_1[0] != 1)
          goto yyfl_337_1_1_1_5_2;
        ...
        LookupNamedField(yy_1_1_5_2_3_1, yy_1_1_5_2_3_2, yy_1_1_5_2_3_3,
                         yy_1_1_5_2_3_4, &yy_1_1_5_2_3_5, &yy_1_1_5_2_3_6,
                         &yy_1_1_5_2_3_7);
    ...
    yyfl_337_1_1_1:;
      ...
      yy_1_2_2_3 = yyv_Pos;
      yy_1_2_2_4 = ((yy)1);
      CheckField(yy_1_2_2_1, yy_1_2_2_2, yy_1_2_2_3, yy_1_2_2_4, &yy_1_2_2_5,
                 &yy_1_2_2_6);
      yyv_Type = yy_1_2_2_5;
...
LookupFieldForAllFunctors(yyin_1, yyin_2, yyin_3, yyin_4, yyout_1, yyout_2,
                          yyout_3) yy yyin_1;
yy yyin_2;
yy yyin_3;
yy yyin_4;
...
{
  {
    ...
    yyfl_338_1_3_1:;
      ...
      yy_3_2_1_4 = yyv_Pos;
      LookupFieldForAllFunctors(yy_3_2_1_1, yy_3_2_1_2, yy_3_2_1_3, yy_3_2_1_4,
                                &yy_3_2_1_5, &yy_3_2_1_6, &yy_3_2_1_7);
      ...
      yyv_Access2 = yy_3_2_1_7;
      {
        ...
        if (yyeq_IDENT(yy_3_2_2_1_1_1, yy_3_2_2_1_1_2))
          goto yyfl_338_1_3_2_2_1;
        yy_3_2_2_1_2_1 = ((yy) "'");
        ...
        MESSAGE2(yy_3_2_2_1_2_1, yy_3_2_2_1_2_2, yy_3_2_2_1_2_3, yy_3_2_2_1_2_4,
                 yy_3_2_2_1_2_5, yy_3_2_2_1_2_6);
      ...
      yyv_Type = yy_3_2_3_1;
      {
        ...
        if ((long)yy_3_2_4_1_1_1 == (long)yy_3_2_4_1_1_2)
          goto yyfl_338_1_3_2_4_1;
        yy_3_2_4_1_2_1 = ((yy) "'");
        ...
        MESSAGE2(yy_3_2_4_1_2_1, yy_3_2_4_1_2_2, yy_3_2_4_1_2_3, yy_3_2_4_1_2_4,
                 yy_3_2_4_1_2_5, yy_3_2_4_1_2_6);
      ...
      yyv_Offset = yy_3_2_5_1;
      {
        ...
        if (yy_3_2_6_1_1_1[0] != 1)
          goto yyfl_338_1_3_2_6_1;
        yy_3_2_6_1_2_2 = yyv_Access2;
        yy_3_2_6_1_2_1 = yy_3_2_6_1_2_2;
        if (yy_3_2_6_1_2_1[0] != 1)
          goto yyfl_338_1_3_2_6_1;
...
GetFunctorSpecForCode(yyin_1, yyin_2, yyin_3, yyout_1) yy yyin_1;
yy yyin_2;
yy yyin_3;
yy *yyout_1;
{
...
LookupNamedField(yyin_1, yyin_2, yyin_3, yyin_4, yyout_1, yyout_2,
                 yyout_3) yy yyin_1;
yy yyin_2;
yy yyin_3;
yy yyin_4;
...
{
  {
    ...
    yyv_Pos = yy_0_4;
    {
      ...
      yy_1_1_2_1 = yyv_Id1;
      yy_1_1_2_2 = yyv_Id;
      if (!yyeq_IDENT(yy_1_1_2_1, yy_1_1_2_2))
        goto yyfl_340_1_1_1;
      yy_1_1_3_2 = yyv_N;
    ...
    yyfl_340_1_1_1:;
      ...
      yy_1_2_1_3 = (yy)(((long)yy_1_2_1_3_1) + ((long)yy_1_2_1_3_2));
      yy_1_2_1_4 = yyv_Pos;
      LookupNamedField(yy_1_2_1_1, yy_1_2_1_2, yy_1_2_1_3, yy_1_2_1_4,
                       &yy_1_2_1_5, &yy_1_2_1_6, &yy_1_2_1_7);
      yyv_Type = yy_1_2_1_5;
...
CheckKey(yyin_1, yyin_2, yyout_1) yy yyin_1;
yy yyin_2;
yy *yyout_1;
{
  {
    ...
    yyv_Pos = yy_0_2;
    yy_1_1 = yyv_Key;
    if (!HasLocalMeaning(yy_1_1))
      goto yyfl_341_1;
    yy_2_1 = yyv_Key;
    if (!GetLocalMeaning(yy_2_1, &yy_2_2))
      goto yyfl_341_1;
    yyv_Meaning = yy_2_2;
    yy_3_1 = yyv_Meaning;
    yy_3_2 = yyv_Pos;
...
GetTableFields(yyin_1, yyin_2, yyout_1) yy yyin_1;
yy yyin_2;
yy *yyout_1;
{
  {
...
CheckField(yyin_1, yyin_2, yyin_3, yyin_4, yyout_1, yyout_2) yy yyin_1;
yy yyin_2;
yy yyin_3;
yy yyin_4;
yy *yyout_1;
...
CheckForUndefinedFields(yyin_1) yy yyin_1;
{
  {
    yy yyb;
    yy yy_0_1;
...
MatchArgs(yyin_1, yyin_2) yy yyin_1;
yy yyin_2;
{
  {
    yy yyb;
...
MatchArg(yyin_1, yyin_2) yy yyin_1;
yy yyin_2;
{
  {
    yy yyb;
    ...
    yyfl_348_1_1_1:;
      ...
      yyv_Args = yy_1_2_1_2_5;
      {
        ...
        if (!yyeq_IDENT(yy_1_2_2_1_1_1, yy_1_2_2_1_1_2))
          goto yyfl_348_1_1_2_2_1;
      ...
      yyfl_348_1_1_2_2_1:;
        ...
        MESSAGE2(yy_1_2_2_2_1_1, yy_1_2_2_2_1_2, yy_1_2_2_2_1_3, yy_1_2_2_2_1_4,
                 yy_1_2_2_2_1_5, yy_1_2_2_2_1_6);
        goto yysl_348_1_1_2_2;
      yysl_348_1_1_2_2:;
        yyb = yysb;
      }
  ...
  }
  {
      ...
      yyExtend();
    {
      yy yysb = yyb;
      {
        ...
        if (yy_1_1_1_1_1_2[0] != 1)
          goto yyfl_348_3_1_1_1_1;
        ...
        GetFunctorCode(yy_1_1_1_1_2_1, yy_1_1_1_1_2_2, &yy_1_1_1_1_2_3,
                       &yy_1_1_1_1_2_4);
        ...
        DefineLocalVar(yy_1_1_1_1_3_1, yy_1_1_1_1_3_2, yy_1_1_1_1_3_3,
                       yy_1_1_1_1_3_4);
      ...
      yyfl_348_3_1_1_1_1:;
        ...
        GetFunctorCode(yy_1_1_1_2_2_1, yy_1_1_1_2_2_2, &yy_1_1_1_2_2_3,
                       &yy_1_1_1_2_2_4);
        ...
        DefineLocalVar(yy_1_1_1_2_3_1, yy_1_1_1_2_3_2, yy_1_1_1_2_3_3,
                       yy_1_1_1_2_3_4);
        goto yysl_348_3_1_1_1;
      yyfl_348_3_1_1_1_2:;
        goto yyfl_348_3_1_1;
...
FieldsToArgSpecs(yyin_1, yyin_2, yyout_1) yy yyin_1;
yy yyin_2;
yy *yyout_1;
{
  {
...
AssignDefArgs(yyin_1, yyin_2, yyin_3) yy yyin_1;
yy yyin_2;
yy yyin_3;
{
  {
...
AssignDefArg(yyin_1, yyin_2, yyin_3) yy yyin_1;
yy yyin_2;
yy yyin_3;
{
  {
...
ApplyFunctor(yyin_1, yyin_2, yyin_3, yyout_1, yyout_2) yy yyin_1;
yy yyin_2;
yy yyin_3;
yy *yyout_1;
yy *yyout_2;
{
  {
    ...
    yyv_P = yy_0_3;
    yy_1_1 = yyv_Type;
    if (!IsNamedType(yy_1_1, &yy_1_2))
      goto yyfl_352_1;
    yyv_FunctorSpecs = yy_1_2;
    yy_2_1 = yyv_Functor;
    yy_2_2 = yyv_FunctorSpecs;
    yy_2_3 = ((yy)1);
    if (!LookupFunctor(yy_2_1, yy_2_2, yy_2_3, &yy_2_4, &yy_2_5))
      goto yyfl_352_1;
    yyv_Code = yy_2_4;
    yyv_Args = yy_2_5;
    yy_0_4 = yyv_Code;
...
GetFunctorCode(yyin_1, yyin_2, yyout_1, yyout_2) yy yyin_1;
yy yyin_2;
yy *yyout_1;
yy *yyout_2;
{
  {
    ...
    yyv_Type = yy_0_2;
    {
      yy yysb = yyb;
      yy_1_1_1_1 = yyv_Type;
      if (!IsNamedType(yy_1_1_1_1, &yy_1_1_1_2))
        goto yyfl_353_1_1_1;
      yyv_FunctorSpecs = yy_1_1_1_2;
      yy_1_1_2_1 = yyv_Functor;
      yy_1_1_2_2 = yyv_FunctorSpecs;
      yy_1_1_2_3 = ((yy)1);
      if (!LookupFunctor(yy_1_1_2_1, yy_1_1_2_2, yy_1_1_2_3, &yy_1_1_2_4,
                         &yy_1_1_2_5))
        goto yyfl_353_1_1_1;
      yyv_Code = yy_1_1_2_4;
      yyv_Args = yy_1_1_2_5;
...
int LookupFunctor(yyin_1, yyin_2, yyin_3, yyout_1, yyout_2) yy yyin_1;
yy yyin_2;
yy yyin_3;
yy *yyout_1;
yy *yyout_2;
{
  ...
  }
  {
    ...
    if (!LookupFunctor(yy_1_1, yy_1_2, yy_1_3, &yy_1_4, &yy_1_5))
      goto yyfl_354_2;
    yyv_Code = yy_1_4;
    yyv_Args = yy_1_5;
    yy_0_4 = yyv_Code;
...
int IsNamedType(yyin_1, yyout_1) yy yyin_1;
yy *yyout_1;
{
  {
    yy yyb;
...
BuildArg(yyin_1, yyin_2) yy yyin_1;
yy yyin_2;
{
  {
    yy yyb;
  ...
  }
  {
    ...
    yyv_ExpType = yy_0_2_2;
    {
      yy yysb = yyb;
      yy_1_1_1_1 = yyv_Name;
      if (!HasLocalMeaning(yy_1_1_1_1))
        goto yyfl_357_5_1_1;
      yy_1_1_2_1 = yyv_Name;
      if (!GetLocalMeaning(yy_1_1_2_1, &yy_1_1_2_2))
        goto yyfl_357_5_1_1;
      yyv_VarType = yy_1_1_2_2;
      yy_1_1_3_1 = yyv_Name;
      if (!GetLocalMeaning2(yy_1_1_3_1, &yy_1_1_3_2))
        goto yyfl_357_5_1_1;
      yyv_FunctorCode = yy_1_1_3_2;
      {
        ...
        if (!yyeq_IDENT(yy_1_1_4_1_1_1, yy_1_1_4_1_1_2))
          goto yyfl_357_5_1_1_4_1;
      ...
      yyfl_357_5_1_1_4_1:;
        ...
        MESSAGE2(yy_1_1_4_2_1_1, yy_1_1_4_2_1_2, yy_1_1_4_2_1_3, yy_1_1_4_2_1_4,
                 yy_1_1_4_2_1_5, yy_1_1_4_2_1_6);
        goto yysl_357_5_1_1_4;
      yysl_357_5_1_1_4:;
        yyb = yysb;
      }
...
CountFunctorArgs(yyin_1, yyout_1) yy yyin_1;
yy *yyout_1;
{
  {
    yy yyb;
...
CheckInt(yyin_1, yyin_2) yy yyin_1;
yy yyin_2;
{
  {
    yy yyb;
...
CheckString(yyin_1, yyin_2) yy yyin_1;
yy yyin_2;
{
  {
    yy yyb;
...
AssignSons(yyin_1, yyin_2, yyin_3) yy yyin_1;
yy yyin_2;
yy yyin_3;
{
  {
...
AssignSon(yyin_1, yyin_2, yyin_3) yy yyin_1;
yy yyin_2;
yy yyin_3;
{
  {
...
DefYYSTYPE() {
  {
    ...
    if (yy_1 == (yy)yyu)
      yyErr(1, 4056);
    yyv_N = yy_1;
    yy_2_1 = ((yy) "typedef struct {long attr[");
    s(yy_2_1);
    yy_3_1_1 = yyv_N;
    yy_3_1_2 = ((yy)1);
    yy_3_1 = (yy)(((long)yy_3_1_1) + ((long)yy_3_1_2));
...
SetTempo(yyin_1, yyin_2) yy yyin_1;
yy yyin_2;
{
  {
    yy yyb;
...
GetTempo(yyin_1, yyout_1) yy yyin_1;
yy *yyout_1;
{
  {
    yy yyb;
...
SetINT(yyin_1, yyin_2) yy yyin_1;
yy yyin_2;
{
  {
    yy yyb;
...
GetINT(yyin_1, yyout_1) yy yyin_1;
yy *yyout_1;
{
  {
    yy yyb;
...
GetUseArgTmp(yyin_1, yyout_1) yy yyin_1;
yy *yyout_1;
{
  {
    yy yyb;
...
GetDefArgTmp(yyin_1, yyout_1) yy yyin_1;
yy *yyout_1;
{
  {
    yy yyb;
...
ChoicePrelude() {
  {
    ...
    s(yy_1_1);
    nl();
    yy_3_1 = ((yy) "static long yyInfin = 123456789;");
    s(yy_3_1);
    nl();
    ...
    nl();
    yy_9_1 = ((
        yy) "typedef struct {yy firstblock; yy curblock; yy curpos;} yysave;");
    s(yy_9_1);
    nl();
    return;
  }
}
SelectChoiceTypes(yyin_1) yy yyin_1;
{
  {
    yy yyb;
    yy yy_0_1;
    ...
    yyv_Rules = yy_1_2_3_4;
    {
      ...
      if (yy_2_1_1_2[0] != 2)
        goto yyfl_401_1_2_1;
      yy_2_1_2_1 =
          ((yy) "CHOICE predicate requires at least one input argument");
      yy_2_1_2_2 = yyv_P;
      MESSAGE(yy_2_1_2_1, yy_2_1_2_2);
      goto yysl_401_1_2;
    yyfl_401_1_2_1:;
      ...
      yyv_Type = yy_2_2_1_2_1_2;
      {
        ...
        yyfl_401_1_2_2_2_1_2_1:;
          ...
          yy_2_2_2_1_2_2_1_3 =
              ((yy) "' cannot be used as type of primary CHOICE argument");
          yy_2_2_2_1_2_2_1_4 = yyv_P;
          MESSAGE1(yy_2_2_2_1_2_2_1_1, yy_2_2_2_1_2_2_1_2, yy_2_2_2_1_2_2_1_3,
                   yy_2_2_2_1_2_2_1_4);
          goto yysl_401_1_2_2_2_1_2;
      ...
      yyfl_401_1_2_2_2_1:;
        ...
        MESSAGE1(yy_2_2_2_2_1_1, yy_2_2_2_2_1_2, yy_2_2_2_2_1_3,
                 yy_2_2_2_2_1_4);
        goto yysl_401_1_2_2_2;
      yysl_401_1_2_2_2:;
        yyb = yysb;
...
LookupChoiceType(yyin_1, yyin_2, yyout_1) yy yyin_1;
yy yyin_2;
yy *yyout_1;
{
  {
...
EnterChoiceRules(yyin_1, yyin_2) yy yyin_1;
yy yyin_2;
{
  {
    yy yyb;
    ...
    yyv_Rules = yy_0_2_2;
    {
      ...
      yyv_Arg = yy_1_1_1_2_1;
      {
        ...
        if (yy_1_1_2_1_1_2[0] != 3)
          goto yyfl_403_1_1_1_2_1;
      ...
      yyfl_403_1_1_1_2_1:;
        ...
        yy_1_1_2_2_1_2 = yy_1_1_2_2_1_1;
        if (yy_1_1_2_2_1_2[0] != 1)
          goto yyfl_403_1_1_1_2_2;
        yy_1_1_2_2_1_2_1 = ((yy)yy_1_1_2_2_1_2[1]);
        yy_1_1_2_2_1_2_2 = ((yy)yy_1_1_2_2_1_2[2]);
        yy_1_1_2_2_1_2_3 = ((yy)yy_1_1_2_2_1_2[3]);
        yy_1_1_2_2_1_2_4 = ((yy)yy_1_1_2_2_1_2[4]);
        ...
        yyv_FunList = yy_1_1_2_2_2;
        {
          ...
          if (!LookupChoiceFunctor(yy_1_1_2_2_3_1_1_1, yy_1_1_2_2_3_1_1_2,
                                   &yy_1_1_2_2_3_1_1_3))
            goto yyfl_403_1_1_1_2_2_3_1;
          yyv_FunctorIndex = yy_1_1_2_2_3_1_1_3;
          yy_1_1_2_2_3_1_2 = (yy)yyv_FunctorIndex[1];
          if (yy_1_1_2_2_3_1_2 == (yy)yyu)
            yyErr(1, 4346);
      ...
      yyfl_403_1_1_1_2_2:;
        yy_1_1_2_3_1_1 =
            ((yy) "primary CHOICE argument must be term or variable");
    ...
    yyv_PList = yy_2;
    {
      ...
      if (!IsInPredicateList(yy_3_1_1_1, yy_3_1_1_2))
        goto yyfl_403_1_3_1;
      goto yysl_403_1_3;
    yyfl_403_1_3_1:;
      yyb = yyh;
...
int LookupChoiceFunctor(yyin_1, yyin_2, yyout_1) yy yyin_1;
yy yyin_2;
yy *yyout_1;
{
  {
    ...
    yyfl_404_1_1_1:;
      yy_1_2_1_1 = yyv_Functor;
      yy_1_2_1_2 = yyv_Tail;
      if (!LookupChoiceFunctor(yy_1_2_1_1, yy_1_2_1_2, &yy_1_2_1_3))
        goto yyfl_404_1_1_2;
      yyv_Index = yy_1_2_1_3;
      goto yysl_404_1_1;
    yyfl_404_1_1_2:;
...
CodeChoiceTypes(yyin_1) yy yyin_1;
{
  {
    yy yyb;
    yy yy_0_1;
...
CodeChoiceType(yyin_1, yyin_2) yy yyin_1;
yy yyin_2;
{
  {
    yy yyb;
    ...
    s(yy_11_1);
    nl();
    yy_13_1 = ((yy) "long yycost;");
    s(yy_13_1);
    nl();
    yy_15_1 = ((yy) "long yyapplied;");
    s(yy_15_1);
    nl();
    yy_17 = yyv_Index;
    ...
    yy_23_1 = yyv_Type;
    if (!GetGlobalMeaning(yy_23_1, &yy_23_2))
      goto yyfl_407_1;
    if (yy_23_2[0] != 1)
      goto yyfl_407_1;
...
LengthPredicateList(yyin_1, yyout_1) yy yyin_1;
yy *yyout_1;
{
  {
    yy yyb;
...
CodeBuildCntlPredicateInfo(yyin_1, yyin_2) yy yyin_1;
yy yyin_2;
{
  {
    yy yyb;
...
CodeBuildCntlSons(yyin_1, yyin_2) yy yyin_1;
yy yyin_2;
{
  {
    yy yyb;
...
int IsInPredicateList(yyin_1, yyin_2) yy yyin_1;
yy yyin_2;
{
  {
    yy yyb;
    ...
    yyfl_412_1_1_1:;
      yy_1_2_1_1 = yyv_Id;
      yy_1_2_1_2 = yyv_Tail;
      if (!IsInPredicateList(yy_1_2_1_1, yy_1_2_1_2))
        goto yyfl_412_1_1_2;
      goto yysl_412_1_1;
    yyfl_412_1_1_2:;
      goto yyfl_412_1;
...
CodeTopFunctorCases(yyin_1, yyin_2) yy yyin_1;
yy yyin_2;
{
  {
    yy yyb;
...
CodeNonTopFunctorCases(yyin_1, yyin_2, yyin_3) yy yyin_1;
yy yyin_2;
yy yyin_3;
{
  {
    ...
    CodeBuildCntlSons(yy_24_1, yy_24_2);
    {
      ...
      if (!IsInChoiceFunctorList(yy_25_1_1_1, yy_25_1_1_2, &yy_25_1_1_3))
        goto yyfl_416_1_25_1;
...
int IsInChoiceFunctorList(yyin_1, yyin_2, yyout_1) yy yyin_1;
yy yyin_2;
yy *yyout_1;
{
  {
    ...
    yyfl_417_1_1_1:;
      yy_1_2_1_1 = yyv_Id;
      yy_1_2_1_2 = yyv_Tail;
      if (!IsInChoiceFunctorList(yy_1_2_1_1, yy_1_2_1_2, &yy_1_2_1_3))
        goto yyfl_417_1_1_2;
      yyv_Index = yy_1_2_1_3;
      goto yysl_417_1_1;
    yyfl_417_1_1_2:;
...
LengthArgSpecList(yyin_1, yyout_1) yy yyin_1;
yy *yyout_1;
{
  {
    yy yyb;
...
DeclareSonCntl(yyin_1, yyin_2) yy yyin_1;
yy yyin_2;
{
  {
    yy yyb;
...
CodeTrySons(yyin_1, yyin_2) yy yyin_1;
yy yyin_2;
{
  {
    yy yyb;
    ...
    yyv_List = yy_1;
    {
      ...
      yy_2_1_1_1 = yyv_Type;
      yy_2_1_1_2 = yyv_List;
      if (!IsInChoiceTypeList(yy_2_1_1_1, yy_2_1_1_2))
        goto yyfl_420_1_2_1;
...
CodeTryRules(yyin_1, yyin_2, yyin_3) yy yyin_1;
yy yyin_2;
yy yyin_3;
{
  {
...
CodeTryRule(yyin_1, yyin_2, yyin_3) yy yyin_1;
yy yyin_2;
yy yyin_3;
{
  {
...
LookupPath(yyin_1, yyin_2, yyin_3, yyout_1) yy yyin_1;
yy yyin_2;
yy yyin_3;
yy *yyout_1;
{
...
GetPathes(yyin_1, yyin_2, yyin_3, yyin_4, yyout_1) yy yyin_1;
yy yyin_2;
yy yyin_3;
yy yyin_4;
yy *yyout_1;
...
GetPathes_Args(yyin_1, yyin_2, yyin_3, yyin_4, yyout_1) yy yyin_1;
yy yyin_2;
yy yyin_3;
yy yyin_4;
yy *yyout_1;
...
MakePathes(yyin_1, yyin_2, yyin_3, yyout_1) yy yyin_1;
yy yyin_2;
yy yyin_3;
yy *yyout_1;
{
...
MakePathes_Args(yyin_1, yyin_2, yyin_3, yyout_1) yy yyin_1;
yy yyin_2;
yy yyin_3;
yy *yyout_1;
{
...
CodeTryConditions(yyin_1, yyin_2, yyin_3, yyout_1) yy yyin_1;
yy yyin_2;
yy yyin_3;
yy *yyout_1;
{
  {
    ...
    yyv_OldList = yy_0_3;
    {
      ...
      yyv_Offset = yy_1_1_1_2_5;
      {
        ...
        if (!GetGlobalMeaning(yy_1_1_2_1_1_1, &yy_1_1_2_1_1_2))
          goto yyfl_435_1_1_1_2_1;
        if (yy_1_1_2_1_1_2[0] != 5)
          goto yyfl_435_1_1_1_2_1;
        {
          yy yysb = yyb;
          yy_1_1_2_1_2_1_1_1 = yyv_Predicate;
          if (!IsRelation(yy_1_1_2_1_2_1_1_1))
            goto yyfl_435_1_1_1_2_1_2_1;
          {
            yy yysb = yyb;
            yy_1_1_2_1_2_1_2_1_1_1 = yyv_InArgs;
            yy_1_1_2_1_2_1_2_1_1_2 = yy_1_1_2_1_2_1_2_1_1_1;
            if (yy_1_1_2_1_2_1_2_1_1_2[0] != 1)
              goto yyfl_435_1_1_1_2_1_2_1_2_1;
            ...
            if (yy_1_1_2_1_2_1_2_1_1_2_3[0] != 1)
              goto yyfl_435_1_1_1_2_1_2_1_2_1;
            ...
            if (yy_1_1_2_1_2_1_2_1_1_2_3_3[0] != 2)
              goto yyfl_435_1_1_1_2_1_2_1_2_1;
          ...
          yy_1_1_2_1_2_1_3_2_3_3_1 = ((yy)yy_1_1_2_1_2_1_3_2_3_3[1]);
          {
            ...
            if (yy_1_1_2_1_2_1_4_1_1_2[0] != 5)
              goto yyfl_435_1_1_1_2_1_2_1_4_1;
            ...
            yyv_VarPos = yy_1_1_2_1_2_1_4_1_1_2_3;
            {
              ...
              if (!GetLocalMeaning(yy_1_1_2_1_2_1_4_1_2_1_1_1,
                                   &yy_1_1_2_1_2_1_4_1_2_1_1_2))
                goto yyfl_435_1_1_1_2_1_2_1_4_1_2_1;
            ...
            yyfl_435_1_1_1_2_1_2_1_4_1_2_1:;
              ...
              yy_1_1_2_1_2_1_4_1_2_2_1_3 =
                  ((yy) "' is not (component of) primary CHOICE argument");
              yy_1_1_2_1_2_1_4_1_2_2_1_4 = yyv_VarPos;
              MESSAGE1(yy_1_1_2_1_2_1_4_1_2_2_1_1, yy_1_1_2_1_2_1_4_1_2_2_1_2,
                       yy_1_1_2_1_2_1_4_1_2_2_1_3, yy_1_1_2_1_2_1_4_1_2_2_1_4);
              yy_1_1_2_1_2_1_4_1_2_2_2 = yyglov_errorId;
              if (yy_1_1_2_1_2_1_4_1_2_2_2 == (yy)yyu)
                yyErr(1, 4686);
          ...
          yyfl_435_1_1_1_2_1_2_1_4_1:;
            ...
            if (yy_1_1_2_1_2_1_4_2_1_2[0] != 6)
              goto yyfl_435_1_1_1_2_1_2_1_4_2;
            ...
            if (yy_1_1_2_1_2_1_4_2_2 == (yy)yyu)
              yyErr(1, 4690);
          ...
          yyfl_435_1_1_1_2_1_2_1_4_2:;
            ...
            if (yy_1_1_2_1_2_1_4_3_1_2[0] != 7)
              goto yyfl_435_1_1_1_2_1_2_1_4_3;
            ...
            if (yy_1_1_2_1_2_1_4_3_2 == (yy)yyu)
              yyErr(1, 4693);
            yyv_Type = yy_1_1_2_1_2_1_4_3_2;
            goto yysl_435_1_1_1_2_1_2_1_4;
          yyfl_435_1_1_1_2_1_2_1_4_3:;
            yy_1_1_2_1_2_1_4_4_1_1 =
                ((yy) "illegal input for condition in CHOICE rule");
            ...
            if (yy_1_1_2_1_2_1_4_4_2 == (yy)yyu)
              yyErr(1, 4696);
          ...
          yyv_TryLabel = yy_1_1_2_1_2_1_5;
          {
            ...
            if (!IsIdent(yy_1_1_2_1_2_1_6_1_1_1, yy_1_1_2_1_2_1_6_1_1_2))
              goto yyfl_435_1_1_1_2_1_2_1_6_1;
            ...
            CodeTryConditionArg(yy_1_1_2_1_2_1_6_1_3_1, yy_1_1_2_1_2_1_6_1_3_2,
                                yy_1_1_2_1_2_1_6_1_3_3);
            ...
            CodeTryConditionArg(yy_1_1_2_1_2_1_6_1_5_1, yy_1_1_2_1_2_1_6_1_5_2,
                                yy_1_1_2_1_2_1_6_1_5_3);
          ...
          yyfl_435_1_1_1_2_1_2_1_6_1:;
            ...
            if (!IsIdent(yy_1_1_2_1_2_1_6_2_1_1, yy_1_1_2_1_2_1_6_2_1_2))
              goto yyfl_435_1_1_1_2_1_2_1_6_2;
            ...
            CodeTryConditionArg(yy_1_1_2_1_2_1_6_2_3_1, yy_1_1_2_1_2_1_6_2_3_2,
                                yy_1_1_2_1_2_1_6_2_3_3);
            ...
            CodeTryConditionArg(yy_1_1_2_1_2_1_6_2_5_1, yy_1_1_2_1_2_1_6_2_5_2,
                                yy_1_1_2_1_2_1_6_2_5_3);
          ...
          yyfl_435_1_1_1_2_1_2_1_6_2:;
            {
              ...
              if (!IsIdent(yy_1_1_2_1_2_1_6_3_1_1_1_1,
                           yy_1_1_2_1_2_1_6_3_1_1_1_2))
                goto yyfl_435_1_1_1_2_1_2_1_6_3_1_1;
              ...
              CodeTryConditionArg(yy_1_1_2_1_2_1_6_3_1_1_5_1,
                                  yy_1_1_2_1_2_1_6_3_1_1_5_2,
                                  yy_1_1_2_1_2_1_6_3_1_1_5_3);
              ...
              CodeTryConditionArg(yy_1_1_2_1_2_1_6_3_1_1_7_1,
                                  yy_1_1_2_1_2_1_6_3_1_1_7_2,
                                  yy_1_1_2_1_2_1_6_3_1_1_7_3);
            ...
            yyfl_435_1_1_1_2_1_2_1_6_3_1_1:;
              ...
              if (!IsIdent(yy_1_1_2_1_2_1_6_3_1_2_1_1,
                           yy_1_1_2_1_2_1_6_3_1_2_1_2))
                goto yyfl_435_1_1_1_2_1_2_1_6_3_1_2;
              ...
              CodeTryConditionArg(yy_1_1_2_1_2_1_6_3_1_2_5_1,
                                  yy_1_1_2_1_2_1_6_3_1_2_5_2,
                                  yy_1_1_2_1_2_1_6_3_1_2_5_3);
              ...
              CodeTryConditionArg(yy_1_1_2_1_2_1_6_3_1_2_7_1,
                                  yy_1_1_2_1_2_1_6_3_1_2_7_2,
                                  yy_1_1_2_1_2_1_6_3_1_2_7_3);
            ...
            yyfl_435_1_1_1_2_1_2_1_6_3_1_2:;
              yy_1_1_2_1_2_1_6_3_1_3_1_1 =
                  ((yy) "relation not defined for type '");
              yy_1_1_2_1_2_1_6_3_1_3_1_2 = yyv_Type;
              yy_1_1_2_1_2_1_6_3_1_3_1_3 = ((yy) "'");
              yy_1_1_2_1_2_1_6_3_1_3_1_4 = yyv_Pos;
              MESSAGE1(yy_1_1_2_1_2_1_6_3_1_3_1_1, yy_1_1_2_1_2_1_6_3_1_3_1_2,
                       yy_1_1_2_1_2_1_6_3_1_3_1_3, yy_1_1_2_1_2_1_6_3_1_3_1_4);
              goto yysl_435_1_1_1_2_1_2_1_6_3_1;
      ...
      yyfl_435_1_1_1_2_1:;
        ...
        if (!IsPredicate(yy_1_1_2_2_1_1, yy_1_1_2_2_1_2, yy_1_1_2_2_1_3,
                         &yy_1_1_2_2_1_4, &yy_1_1_2_2_1_5, &yy_1_1_2_2_1_6,
                         &yy_1_1_2_2_1_7))
          goto yyfl_435_1_1_1_2_2;
        ...
        yyv_FormalOutArgs = yy_1_1_2_2_1_7;
        {
          ...
          yy_1_1_2_2_2_1_1_2 = yy_1_1_2_2_2_1_1_1;
          if (yy_1_1_2_2_2_1_1_2[0] != 2)
            goto yyfl_435_1_1_1_2_2_2_1;
          ...
          CodeTryConditionArgs(yy_1_1_2_2_2_1_5_1, yy_1_1_2_2_2_1_5_2,
                               yy_1_1_2_2_2_1_5_3, &yy_1_1_2_2_2_1_5_4);
        ...
        yyfl_435_1_1_1_2_2_2_1:;
            ...
            goto yyfl_435_1_1_1_2_2_2_2;
          {
            ...
            yyv_ArgPos = yy_1_1_2_2_2_2_2_1_1_2_2;
            {
              ...
              if (yy_1_1_2_2_2_2_2_1_2_1_1_2[0] != 5)
                goto yyfl_435_1_1_1_2_2_2_2_2_1_2_1;
              yy_1_1_2_2_2_2_2_1_2_1_1_2_1 =
                  ((yy)yy_1_1_2_2_2_2_2_1_2_1_1_2[1]);
              yy_1_1_2_2_2_2_2_1_2_1_1_2_2 =
                  ((yy)yy_1_1_2_2_2_2_2_1_2_1_1_2[2]);
              yy_1_1_2_2_2_2_2_1_2_1_1_2_3 =
                  ((yy)yy_1_1_2_2_2_2_2_1_2_1_1_2[3]);
              ...
              yyv_VarPos = yy_1_1_2_2_2_2_2_1_2_1_1_2_3;
              {
                ...
                if (!GetLocalMeaning(yy_1_1_2_2_2_2_2_1_2_1_2_1_1_1,
                                     &yy_1_1_2_2_2_2_2_1_2_1_2_1_1_2))
                  goto yyfl_435_1_1_1_2_2_2_2_2_1_2_1_2_1;
              ...
              yyfl_435_1_1_1_2_2_2_2_2_1_2_1_2_1:;
                ...
                yy_1_1_2_2_2_2_2_1_2_1_2_2_1_3 =
                    ((yy) "' is not (component of) primary CHOICE argument");
                yy_1_1_2_2_2_2_2_1_2_1_2_2_1_4 = yyv_VarPos;
                MESSAGE1(yy_1_1_2_2_2_2_2_1_2_1_2_2_1_1,
                         yy_1_1_2_2_2_2_2_1_2_1_2_2_1_2,
                         yy_1_1_2_2_2_2_2_1_2_1_2_2_1_3,
                         yy_1_1_2_2_2_2_2_1_2_1_2_2_1_4);
                yy_1_1_2_2_2_2_2_1_2_1_2_2_2 = yyglov_errorId;
                if (yy_1_1_2_2_2_2_2_1_2_1_2_2_2 == (yy)yyu)
                  yyErr(1, 4754);
              ...
              LookupPath(yy_1_1_2_2_2_2_2_1_2_1_3_1, yy_1_1_2_2_2_2_2_1_2_1_3_2,
                         yy_1_1_2_2_2_2_2_1_2_1_3_3,
                         &yy_1_1_2_2_2_2_2_1_2_1_3_4);
              yyv_Path = yy_1_1_2_2_2_2_2_1_2_1_3_4;
              yy_1_1_2_2_2_2_2_1_2_1_4 = yyglov_choice_Types;
              if (yy_1_1_2_2_2_2_2_1_2_1_4 == (yy)yyu)
                yyErr(1, 4757);
              yyv_TypeList = yy_1_1_2_2_2_2_2_1_2_1_4;
              yy_1_1_2_2_2_2_2_1_2_1_5_1 = yyv_TypeList;
              yy_1_1_2_2_2_2_2_1_2_1_5_2 = yyv_Type;
              GetChoiceTypeIndex(yy_1_1_2_2_2_2_2_1_2_1_5_1,
                                 yy_1_1_2_2_2_2_2_1_2_1_5_2,
                                 &yy_1_1_2_2_2_2_2_1_2_1_5_3);
              ...
              yy_1_1_2_2_2_2_2_1_2_1_6_1[1] =
                  ((long)yy_1_1_2_2_2_2_2_1_2_1_6_1_1);
              yy_1_1_2_2_2_2_2_1_2_1_6_1[2] =
                  ((long)yy_1_1_2_2_2_2_2_1_2_1_6_1_2);
              yy_1_1_2_2_2_2_2_1_2_1_6_1[3] =
                  ((long)yy_1_1_2_2_2_2_2_1_2_1_6_1_3);
              yy_1_1_2_2_2_2_2_1_2_1_6_1[4] =
                  ((long)yy_1_1_2_2_2_2_2_1_2_1_6_1_4);
              yy_1_1_2_2_2_2_2_1_2_1_6_1[5] =
                  ((long)yy_1_1_2_2_2_2_2_1_2_1_6_1_5);
            ...
            yyfl_435_1_1_1_2_2_2_2_2_1_2_1:;
              yy_1_1_2_2_2_2_2_1_2_2_1_1 =
                  ((yy) "illegal input for CHOICE predicate");
          ...
          yyfl_435_1_1_1_2_2_2_2_2_1:;
            ...
            if (yy_1_1_2_2_2_2_2_2_1_2[0] != 2)
              goto yyfl_435_1_1_1_2_2_2_2_2_2;
...
CodeTryConditionOutArgs(yyin_1, yyin_2) yy yyin_1;
yy yyin_2;
{
  {
    yy yyb;
...
int IsInChoiceTypeList(yyin_1, yyin_2) yy yyin_1;
yy yyin_2;
{
  {
    yy yyb;
    ...
    yyfl_437_1_1_1:;
      yy_1_2_1_1 = yyv_Type;
      yy_1_2_1_2 = yyv_Tail;
      if (!IsInChoiceTypeList(yy_1_2_1_1, yy_1_2_1_2))
        goto yyfl_437_1_1_2;
      goto yysl_437_1_1;
    yyfl_437_1_1_2:;
      goto yyfl_437_1;
...
GetChoiceTypeIndex(yyin_1, yyin_2, yyout_1) yy yyin_1;
yy yyin_2;
yy *yyout_1;
{
  {
...
CodeTryConditionArgs(yyin_1, yyin_2, yyin_3, yyout_1) yy yyin_1;
yy yyin_2;
yy yyin_3;
yy *yyout_1;
{
...
CodeTryConditionArg(yyin_1, yyin_2, yyin_3) yy yyin_1;
yy yyin_2;
yy yyin_3;
{
  {
    ...
    yyv_Pathes = yy_0_3;
    {
      ...
      yyv_Name = yy_1_1_1_2_2;
      {
        ...
        if (!GetLocalMeaning(yy_1_1_2_1_1_1, &yy_1_1_2_1_1_2))
          goto yyfl_440_1_1_1_2_1;
...
CodeCostUpdate(yyin_1, yyin_2, yyin_3, yyin_4, yyin_5) yy yyin_1;
yy yyin_2;
yy yyin_3;
yy yyin_4;
yy yyin_5;
...
CodeCostComponents(yyin_1) yy yyin_1;
{
  {
    yy yyb;
    yy yy_0_1;
...
GetCntlOffset(yyin_1, yyin_2, yyin_3, yyout_1) yy yyin_1;
yy yyin_2;
yy yyin_3;
yy *yyout_1;
{
...
CodeChoiceRuleProcs_Decls(yyin_1) yy yyin_1;
{
  {
    yy yyb;
    yy yy_0_1;
    ...
    if (yy_0_1_1_1_3_2[0] != 5)
      goto yyfl_444_1;
    if (yy_0_1_1_1_3_3[0] != 1)
      goto yyfl_444_1;
...
CodeChoiceRuleProcs_Rules(yyin_1, yyin_2) yy yyin_1;
yy yyin_2;
{
  {
    yy yyb;
...
CodeChoiceRuleProc(yyin_1, yyin_2) yy yyin_1;
yy yyin_2;
{
  {
    yy yyb;
...
SF_Assoc(yyin_1, yyin_2) yy yyin_1;
yy yyin_2;
{
  {
    yy yyb;
...
SF_FunctorSpecList(yyin_1) yy yyin_1;
{
  {
    yy yyb;
    yy yy_0_1;
...
SF_TableFieldList(yyin_1, yyin_2) yy yyin_1;
yy yyin_2;
{
  {
    yy yyb;
...
SF_ArgSpecList(yyin_1, yyin_2) yy yyin_1;
yy yyin_2;
{
  {
    yy yyb;
